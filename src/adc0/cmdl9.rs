...
pub type ADCH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMDL9_SPEC, u8, ADCH_A, 5, O>;
...
pub type CTYPE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CMDL9_SPEC, u8, CTYPE_A, 2, O>;
...
pub type MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMDL9_SPEC, MODE_A, O>;
