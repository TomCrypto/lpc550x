...
pub type FIFO_SEL_B_W<'a, const O: u8> = crate::BitWriter<'a, u32, TCTRL_SPEC, FIFO_SEL_B_A, O>;
impl<'a, const O: u8> FIFO_SEL_B_W<'a, O> {
    #[doc = "Result written to FIFO 0"]
    #[inline(always)]
...
pub type RSYNC_W<'a, const O: u8> = crate::BitWriter<'a, u32, TCTRL_SPEC, bool, O>;
...
impl R {
    ...
    pub fn fifo_sel_b(&self) -> FIFO_SEL_B_R {
        FIFO_SEL_B_R::new(((self.bits >> 2) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 2 - SAR Result Destination For Channel B"]
    #[inline(always)]
    pub fn fifo_sel_b(&mut self) -> FIFO_SEL_B_W<2> {
        FIFO_SEL_B_W::new(self)
    }
    #[doc = "Bits 8:11 - Trigger priority setting"]
    #[inline(always)]
