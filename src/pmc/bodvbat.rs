...
pub type TRIGLVL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, BODVBAT_SPEC, u8, TRIGLVL_A, 5, O>;
...
pub type HYST_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, BODVBAT_SPEC, u8, HYST_A, 2, O>;
...
impl R {
    ...
    pub fn hyst(&self) -> HYST_R {
        HYST_R::new(((self.bits >> 5) & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:4 - BoD trigger level."]
    #[inline(always)]
    pub fn triglvl(&mut self) -> TRIGLVL_W<0> {
        TRIGLVL_W::new(self)
    }
    #[doc = "Bits 5:6 - BoD Hysteresis control."]
    #[inline(always)]
    pub fn hyst(&mut self) -> HYST_W<5> {
        HYST_W::new(self)
    }
