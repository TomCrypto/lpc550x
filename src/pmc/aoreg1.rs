...
pub type CDOGRESET_R = crate::BitReader<bool>;
#[doc = "Field `CDOGRESET` writer - The last chip reset was caused by the code Watchdog."]
pub type CDOGRESET_W<'a, const O: u8> = crate::BitWriter<'a, u32, AOREG1_SPEC, bool, O>;
...
impl R {
    ...
    #[inline(always)]
    pub fn cdogreset(&self) -> CDOGRESET_R {
        CDOGRESET_R::new(((self.bits >> 13) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 13 - The last chip reset was caused by the code Watchdog."]
    #[inline(always)]
    pub fn cdogreset(&mut self) -> CDOGRESET_W<13> {
        CDOGRESET_W::new(self)
    }
    #[doc = "Bits 16:19 - ROM Boot Fatal Error Counter."]
    #[inline(always)]
