...
pub enum FUNC_A {
    ...
    SCT0_GPI5 = 4,
    #[doc = "5: Slave Select 1 for high-speed SPI."]
    HS_SPI_SSEL1 = 5,
    #[doc = "9: PLU output 4."]
    PLU_OUT4 = 9,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            ...
            3 => Some(FUNC_A::CTIMER_INP3),
            4 => Some(FUNC_A::SCT0_GPI5),
            5 => Some(FUNC_A::HS_SPI_SSEL1),
            9 => Some(FUNC_A::PLU_OUT4),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `CTIMER_INP3`"]
    #[inline(always)]
    pub fn is_ctimer_inp3(&self) -> bool {
        *self == FUNC_A::CTIMER_INP3
    }
    ...
    #[doc = "Checks if the value of the field is `HS_SPI_SSEL1`"]
    #[inline(always)]
    pub fn is_hs_spi_ssel1(&self) -> bool {
        *self == FUNC_A::HS_SPI_SSEL1
    }
    #[doc = "Checks if the value of the field is `PLU_OUT4`"]
    #[inline(always)]
    pub fn is_plu_out4(&self) -> bool {
        *self == FUNC_A::PLU_OUT4
    }
}
#[doc = "Field `FUNC` writer - Selects pin function."]
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO1_1_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    ...
    #[inline(always)]
    pub fn ctimer_inp3(self) -> &'a mut W {
        self.variant(FUNC_A::CTIMER_INP3)
    }
    ...
    #[doc = "Slave Select 1 for high-speed SPI."]
    #[inline(always)]
    pub fn hs_spi_ssel1(self) -> &'a mut W {
        self.variant(FUNC_A::HS_SPI_SSEL1)
    }
    #[doc = "PLU output 4."]
    #[inline(always)]
    pub fn plu_out4(self) -> &'a mut W {
        self.variant(FUNC_A::PLU_OUT4)
    }
}
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_1_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_1_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_1_SPEC, DIGIMODE_A, O>;
