...
pub enum FUNC_A {
    ...
    PIO0_8 = 0,
    #[doc = "1: Flexcomm 3 SPI slave select 3."]
    FC3_SSEL3 = 1,
    #[doc = "3: Flexcomm 5 USART receiver, I2C data I/O, SPI master-out/slave-in data, I2S data I/O."]
    FC5_RXD_SDA_MOSI_DATA = 3,
    #[doc = "4: Serial Wire Debug trace output."]
    SWO = 4,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            ...
            1 => Some(FUNC_A::FC3_SSEL3),
            3 => Some(FUNC_A::FC5_RXD_SDA_MOSI_DATA),
            4 => Some(FUNC_A::SWO),
            10 => Some(FUNC_A::SEC_PIO0_8),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `FC3_SSEL3`"]
    #[inline(always)]
    pub fn is_fc3_ssel3(&self) -> bool {
        *self == FUNC_A::FC3_SSEL3
    }
    #[doc = "Checks if the value of the field is `FC5_RXD_SDA_MOSI_DATA`"]
    #[inline(always)]
    pub fn is_fc5_rxd_sda_mosi_data(&self) -> bool {
        *self == FUNC_A::FC5_RXD_SDA_MOSI_DATA
    }
    ...
    #[doc = "Checks if the value of the field is `SEC_PIO0_8`"]
    #[inline(always)]
    pub fn is_sec_pio0_8(&self) -> bool {
        *self == FUNC_A::SEC_PIO0_8
    }
}
#[doc = "Field `FUNC` writer - Selects pin function."]
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO0_8_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    ...
    #[doc = "Flexcomm 3 SPI slave select 3."]
    #[inline(always)]
    pub fn fc3_ssel3(self) -> &'a mut W {
        self.variant(FUNC_A::FC3_SSEL3)
    }
    #[doc = "Flexcomm 5 USART receiver, I2C data I/O, SPI master-out/slave-in data, I2S data I/O."]
    #[inline(always)]
    pub fn fc5_rxd_sda_mosi_data(self) -> &'a mut W {
        self.variant(FUNC_A::FC5_RXD_SDA_MOSI_DATA)
    }
    ...
    #[doc = "Secure GPIO pin."]
    #[inline(always)]
    pub fn sec_pio0_8(self) -> &'a mut W {
        self.variant(FUNC_A::SEC_PIO0_8)
    }
}
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_8_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_8_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_8_SPEC, DIGIMODE_A, O>;
