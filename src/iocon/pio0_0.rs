...
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General-purpose digital input/output pin. Comparator 0, input A in analog mode."]
    PIO0_0_ACMP0_A = 0,
    #[doc = "2: Flexcomm 3 USART, SPI or I2S clock."]
    FC3_SCK = 2,
    #[doc = "3: CTimer0 match output 0."]
    CTIMER0_MAT0 = 3,
    #[doc = "4: Pin input 0 to SCTimer/PWM."]
    SCT0_GPI0 = 4,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::PIO0_0_ACMP0_A),
            2 => Some(FUNC_A::FC3_SCK),
            3 => Some(FUNC_A::CTIMER0_MAT0),
            4 => Some(FUNC_A::SCT0_GPI0),
            10 => Some(FUNC_A::SEC_PIO0_0),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `PIO0_0_ACMP0_A`"]
    #[inline(always)]
    pub fn is_pio0_0_acmp0_a(&self) -> bool {
        *self == FUNC_A::PIO0_0_ACMP0_A
    }
    #[doc = "Checks if the value of the field is `FC3_SCK`"]
    #[inline(always)]
    pub fn is_fc3_sck(&self) -> bool {
        *self == FUNC_A::FC3_SCK
    }
    #[doc = "Checks if the value of the field is `CTIMER0_MAT0`"]
    #[inline(always)]
    pub fn is_ctimer0_mat0(&self) -> bool {
        *self == FUNC_A::CTIMER0_MAT0
    }
    #[doc = "Checks if the value of the field is `SCT0_GPI0`"]
    #[inline(always)]
    pub fn is_sct0_gpi0(&self) -> bool {
        *self == FUNC_A::SCT0_GPI0
    }
    #[doc = "Checks if the value of the field is `SEC_PIO0_0`"]
    #[inline(always)]
    pub fn is_sec_pio0_0(&self) -> bool {
        *self == FUNC_A::SEC_PIO0_0
    }
}
#[doc = "Field `FUNC` writer - Selects pin function."]
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO0_0_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    #[doc = "General-purpose digital input/output pin. Comparator 0, input A in analog mode."]
    #[inline(always)]
    pub fn pio0_0_acmp0_a(self) -> &'a mut W {
        self.variant(FUNC_A::PIO0_0_ACMP0_A)
    }
    #[doc = "Flexcomm 3 USART, SPI or I2S clock."]
    #[inline(always)]
    pub fn fc3_sck(self) -> &'a mut W {
        self.variant(FUNC_A::FC3_SCK)
    }
    #[doc = "CTimer0 match output 0."]
    #[inline(always)]
    pub fn ctimer0_mat0(self) -> &'a mut W {
        self.variant(FUNC_A::CTIMER0_MAT0)
    }
    #[doc = "Pin input 0 to SCTimer/PWM."]
    #[inline(always)]
    pub fn sct0_gpi0(self) -> &'a mut W {
        self.variant(FUNC_A::SCT0_GPI0)
    }
    #[doc = "Secure GPIO pin."]
    #[inline(always)]
    pub fn sec_pio0_0(self) -> &'a mut W {
        self.variant(FUNC_A::SEC_PIO0_0)
    }
}
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_0_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_0_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_0_SPEC, DIGIMODE_A, O>;
...
pub type ASW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_0_SPEC, ASW_A, O>;
