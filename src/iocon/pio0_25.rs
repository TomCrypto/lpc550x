...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::PIO0_25),
            1 => Some(FUNC_A::FC0_TXD_SCL_MISO_WS),
            3 => Some(FUNC_A::CTIMER_INP9),
            4 => Some(FUNC_A::SCT0_GPI1),
            10 => Some(FUNC_A::SEC_PIO0_25),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `PIO0_25`"]
    #[inline(always)]
    pub fn is_pio0_25(&self) -> bool {
        *self == FUNC_A::PIO0_25
    }
    ...
    #[doc = "Checks if the value of the field is `CTIMER_INP9`"]
    #[inline(always)]
    pub fn is_ctimer_inp9(&self) -> bool {
        *self == FUNC_A::CTIMER_INP9
    }
    ...
    #[doc = "Checks if the value of the field is `SEC_PIO0_25`"]
    #[inline(always)]
    pub fn is_sec_pio0_25(&self) -> bool {
        *self == FUNC_A::SEC_PIO0_25
    }
}
#[doc = "Field `FUNC` writer - Selects pin function."]
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO0_25_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    #[doc = "General-purpose digital input/output pin."]
    #[inline(always)]
    pub fn pio0_25(self) -> &'a mut W {
        self.variant(FUNC_A::PIO0_25)
    }
    ...
    #[inline(always)]
    pub fn ctimer_inp9(self) -> &'a mut W {
        self.variant(FUNC_A::CTIMER_INP9)
    }
    ...
    #[doc = "Secure GPIO pin."]
    #[inline(always)]
    pub fn sec_pio0_25(self) -> &'a mut W {
        self.variant(FUNC_A::SEC_PIO0_25)
    }
}
...
pub type MODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, PIO0_25_SPEC, u8, MODE_A, 2, O>;
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_25_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_25_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_25_SPEC, DIGIMODE_A, O>;
...
pub type OD_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_25_SPEC, OD_A, O>;
