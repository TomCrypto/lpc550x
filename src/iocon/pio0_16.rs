...
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General-purpose digital input/output pin. ADC input channel 8 in analog mode."]
    PIO0_16_ADC0_8 = 0,
    #[doc = "1: Flexcomm 4 USART transmitter, I2C clock, SPI master-in/slave-out data I/O, I2S word-select/frame."]
    FC4_TXD_SCL_MISO_WS = 1,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::PIO0_16_ADC0_8),
            1 => Some(FUNC_A::FC4_TXD_SCL_MISO_WS),
            2 => Some(FUNC_A::CLKOUT),
            3 => Some(FUNC_A::CTIMER_INP4),
            10 => Some(FUNC_A::SEC_PIO0_16),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `PIO0_16_ADC0_8`"]
    #[inline(always)]
    pub fn is_pio0_16_adc0_8(&self) -> bool {
        *self == FUNC_A::PIO0_16_ADC0_8
    }
    ...
    #[doc = "Checks if the value of the field is `SEC_PIO0_16`"]
    #[inline(always)]
    pub fn is_sec_pio0_16(&self) -> bool {
        *self == FUNC_A::SEC_PIO0_16
    }
}
#[doc = "Field `FUNC` writer - Selects pin function."]
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO0_16_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    #[doc = "General-purpose digital input/output pin. ADC input channel 8 in analog mode."]
    #[inline(always)]
    pub fn pio0_16_adc0_8(self) -> &'a mut W {
        self.variant(FUNC_A::PIO0_16_ADC0_8)
    }
    ...
    #[doc = "Secure GPIO pin."]
    #[inline(always)]
    pub fn sec_pio0_16(self) -> &'a mut W {
        self.variant(FUNC_A::SEC_PIO0_16)
    }
}
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_16_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_16_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_16_SPEC, DIGIMODE_A, O>;
...
pub type ASW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_16_SPEC, ASW_A, O>;
