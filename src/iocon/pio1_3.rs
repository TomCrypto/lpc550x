...
pub enum FUNC_A {
    ...
    SCT0_OUT4 = 4,
    #[doc = "6: Master-in/slave-out for high-speed SPI."]
    HS_SPI_MISO = 6,
    #[doc = "9: PLU output 6."]
    PLU_OUT6 = 9,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            ...
            6 => Some(FUNC_A::HS_SPI_MISO),
            9 => Some(FUNC_A::PLU_OUT6),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `HS_SPI_MISO`"]
    #[inline(always)]
    pub fn is_hs_spi_miso(&self) -> bool {
        *self == FUNC_A::HS_SPI_MISO
    }
    #[doc = "Checks if the value of the field is `PLU_OUT6`"]
    #[inline(always)]
    pub fn is_plu_out6(&self) -> bool {
        *self == FUNC_A::PLU_OUT6
    }
}
#[doc = "Field `FUNC` writer - Selects pin function."]
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO1_3_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    ...
    #[doc = "Master-in/slave-out for high-speed SPI."]
    #[inline(always)]
    pub fn hs_spi_miso(self) -> &'a mut W {
        self.variant(FUNC_A::HS_SPI_MISO)
    }
    #[doc = "PLU output 6."]
    #[inline(always)]
    pub fn plu_out6(self) -> &'a mut W {
        self.variant(FUNC_A::PLU_OUT6)
    }
}
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_3_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_3_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_3_SPEC, DIGIMODE_A, O>;
