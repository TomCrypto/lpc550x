...
pub enum FUNC_A {
    ...
    PIO0_27 = 0,
    #[doc = "1: Flexcomm 2 USART transmitter, I2C clock, SPI master-in/slave-out data I/O, I2S word-select/frame."]
    FC2_TXD_SCL_MISO_WS = 1,
    #[doc = "3: CTimer3 match output 2."]
    CTIMER3_MAT2 = 3,
    #[doc = "4: SCTimer/PWM output 6."]
    SCT0_OUT6 = 4,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::PIO0_27),
            1 => Some(FUNC_A::FC2_TXD_SCL_MISO_WS),
            3 => Some(FUNC_A::CTIMER3_MAT2),
            4 => Some(FUNC_A::SCT0_OUT6),
            7 => Some(FUNC_A::FC7_RXD_SDA_MOSI_DATA),
            9 => Some(FUNC_A::PLU_OUT0),
            10 => Some(FUNC_A::SEC_PIO0_27),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `PIO0_27`"]
    #[inline(always)]
    pub fn is_pio0_27(&self) -> bool {
        *self == FUNC_A::PIO0_27
    }
    #[doc = "Checks if the value of the field is `FC2_TXD_SCL_MISO_WS`"]
    #[inline(always)]
    pub fn is_fc2_txd_scl_miso_ws(&self) -> bool {
        *self == FUNC_A::FC2_TXD_SCL_MISO_WS
    }
    #[doc = "Checks if the value of the field is `CTIMER3_MAT2`"]
    #[inline(always)]
    pub fn is_ctimer3_mat2(&self) -> bool {
        *self == FUNC_A::CTIMER3_MAT2
    }
    #[doc = "Checks if the value of the field is `SCT0_OUT6`"]
    #[inline(always)]
    pub fn is_sct0_out6(&self) -> bool {
        *self == FUNC_A::SCT0_OUT6
    }
    ...
    #[doc = "Checks if the value of the field is `PLU_OUT0`"]
    #[inline(always)]
    pub fn is_plu_out0(&self) -> bool {
        *self == FUNC_A::PLU_OUT0
    }
    #[doc = "Checks if the value of the field is `SEC_PIO0_27`"]
    #[inline(always)]
    pub fn is_sec_pio0_27(&self) -> bool {
        *self == FUNC_A::SEC_PIO0_27
    }
}
#[doc = "Field `FUNC` writer - Selects pin function."]
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO0_27_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    #[doc = "General-purpose digital input/output pin."]
    #[inline(always)]
    pub fn pio0_27(self) -> &'a mut W {
        self.variant(FUNC_A::PIO0_27)
    }
    #[doc = "Flexcomm 2 USART transmitter, I2C clock, SPI master-in/slave-out data I/O, I2S word-select/frame."]
    #[inline(always)]
    pub fn fc2_txd_scl_miso_ws(self) -> &'a mut W {
        self.variant(FUNC_A::FC2_TXD_SCL_MISO_WS)
    }
    #[doc = "CTimer3 match output 2."]
    #[inline(always)]
    pub fn ctimer3_mat2(self) -> &'a mut W {
        self.variant(FUNC_A::CTIMER3_MAT2)
    }
    #[doc = "SCTimer/PWM output 6."]
    #[inline(always)]
    pub fn sct0_out6(self) -> &'a mut W {
        self.variant(FUNC_A::SCT0_OUT6)
    }
    ...
    #[doc = "PLU output 0."]
    #[inline(always)]
    pub fn plu_out0(self) -> &'a mut W {
        self.variant(FUNC_A::PLU_OUT0)
    }
    #[doc = "Secure GPIO pin."]
    #[inline(always)]
    pub fn sec_pio0_27(self) -> &'a mut W {
        self.variant(FUNC_A::SEC_PIO0_27)
    }
}
...
pub type MODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, PIO0_27_SPEC, u8, MODE_A, 2, O>;
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_27_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_27_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_27_SPEC, DIGIMODE_A, O>;
...
pub type OD_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_27_SPEC, OD_A, O>;
