...
pub enum FUNC_A {
    ...
    PIO0_28 = 0,
    #[doc = "1: Flexcomm 0 USART, SPI or I2S clock."]
    FC0_SCK = 1,
    #[doc = "3: Capture input to CTimer input multiplexers."]
    CTIMER_INP11 = 3,
    #[doc = "4: SCTimer/PWM output 7."]
    SCT0_OUT7 = 4,
    #[doc = "9: PLU output 1."]
    PLU_OUT1 = 9,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::PIO0_28),
            1 => Some(FUNC_A::FC0_SCK),
            3 => Some(FUNC_A::CTIMER_INP11),
            4 => Some(FUNC_A::SCT0_OUT7),
            9 => Some(FUNC_A::PLU_OUT1),
            10 => Some(FUNC_A::SEC_PIO0_28),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `CTIMER_INP11`"]
    #[inline(always)]
    pub fn is_ctimer_inp11(&self) -> bool {
        *self == FUNC_A::CTIMER_INP11
    }
    #[doc = "Checks if the value of the field is `SCT0_OUT7`"]
    #[inline(always)]
    pub fn is_sct0_out7(&self) -> bool {
        *self == FUNC_A::SCT0_OUT7
    }
    #[doc = "Checks if the value of the field is `PLU_OUT1`"]
    #[inline(always)]
    pub fn is_plu_out1(&self) -> bool {
        *self == FUNC_A::PLU_OUT1
    }
    #[doc = "Checks if the value of the field is `SEC_PIO0_28`"]
    #[inline(always)]
    pub fn is_sec_pio0_28(&self) -> bool {
        *self == FUNC_A::SEC_PIO0_28
    }
}
#[doc = "Field `FUNC` writer - Selects pin function."]
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO0_28_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    #[doc = "General-purpose digital input/output pin."]
    #[inline(always)]
    pub fn pio0_28(self) -> &'a mut W {
        self.variant(FUNC_A::PIO0_28)
    }
    ...
    #[inline(always)]
    pub fn ctimer_inp11(self) -> &'a mut W {
        self.variant(FUNC_A::CTIMER_INP11)
    }
    #[doc = "SCTimer/PWM output 7."]
    #[inline(always)]
    pub fn sct0_out7(self) -> &'a mut W {
        self.variant(FUNC_A::SCT0_OUT7)
    }
    #[doc = "PLU output 1."]
    #[inline(always)]
    pub fn plu_out1(self) -> &'a mut W {
        self.variant(FUNC_A::PLU_OUT1)
    }
    #[doc = "Secure GPIO pin."]
    #[inline(always)]
    pub fn sec_pio0_28(self) -> &'a mut W {
        self.variant(FUNC_A::SEC_PIO0_28)
    }
}
...
pub type MODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, PIO0_28_SPEC, u8, MODE_A, 2, O>;
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_28_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_28_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_28_SPEC, DIGIMODE_A, O>;
...
pub type OD_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_28_SPEC, OD_A, O>;
