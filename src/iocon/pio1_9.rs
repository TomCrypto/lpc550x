...
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General-purpose digital input/output pin. ADC input channel 12 in analog mode."]
    PIO1_9_ADC0_12 = 0,
    #[doc = "2: Flexcomm 1 USART, SPI or I2S clock."]
    FC1_SCK = 2,
    #[doc = "3: Capture input to CTimer input multiplexers."]
    CTIMER_INP4 = 3,
    #[doc = "4: SCTimer/PWM output 2."]
    SCT0_OUT2 = 4,
    #[doc = "5: Flexcomm 4 USART clear-to-send, I2C data I/O, SPI Slave Select 0."]
    FC4_CTS_SDA_SSEL0 = 5,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::PIO1_9_ADC0_12),
            2 => Some(FUNC_A::FC1_SCK),
            3 => Some(FUNC_A::CTIMER_INP4),
            4 => Some(FUNC_A::SCT0_OUT2),
            5 => Some(FUNC_A::FC4_CTS_SDA_SSEL0),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `PIO1_9_ADC0_12`"]
    #[inline(always)]
    pub fn is_pio1_9_adc0_12(&self) -> bool {
        *self == FUNC_A::PIO1_9_ADC0_12
    }
    #[doc = "Checks if the value of the field is `FC1_SCK`"]
    #[inline(always)]
    pub fn is_fc1_sck(&self) -> bool {
        *self == FUNC_A::FC1_SCK
    }
    #[doc = "Checks if the value of the field is `CTIMER_INP4`"]
    #[inline(always)]
    pub fn is_ctimer_inp4(&self) -> bool {
        *self == FUNC_A::CTIMER_INP4
    }
...
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO1_9_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    #[doc = "General-purpose digital input/output pin. ADC input channel 12 in analog mode."]
    #[inline(always)]
    pub fn pio1_9_adc0_12(self) -> &'a mut W {
        self.variant(FUNC_A::PIO1_9_ADC0_12)
    }
    #[doc = "Flexcomm 1 USART, SPI or I2S clock."]
    #[inline(always)]
    pub fn fc1_sck(self) -> &'a mut W {
        self.variant(FUNC_A::FC1_SCK)
    }
    #[doc = "Capture input to CTimer input multiplexers."]
    #[inline(always)]
    pub fn ctimer_inp4(self) -> &'a mut W {
        self.variant(FUNC_A::CTIMER_INP4)
    }
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_9_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_9_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_9_SPEC, DIGIMODE_A, O>;
...
pub type ASW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_9_SPEC, ASW_A, O>;
