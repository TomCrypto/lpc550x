...
pub enum FUNC_A {
    ...
    PIO1_21 = 0,
    #[doc = "1: Flexcomm 7 USART clear-to-send, I2C data I/O, SPI Slave Select 0."]
    FC7_CTS_SDA_SSEL0 = 1,
    #[doc = "3: CTimer3 match output 2."]
    CTIMER3_MAT2 = 3,
    #[doc = "5: Flexcomm 4 USART receiver, I2C data I/O, SPI master-out/slave-in data, I2S data I/O."]
    FC4_RXD_SDA_MOSI_DATA = 5,
    #[doc = "7: PLU output 3."]
    PLU_OUT3 = 7,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            ...
            1 => Some(FUNC_A::FC7_CTS_SDA_SSEL0),
            3 => Some(FUNC_A::CTIMER3_MAT2),
            5 => Some(FUNC_A::FC4_RXD_SDA_MOSI_DATA),
            7 => Some(FUNC_A::PLU_OUT3),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `FC7_CTS_SDA_SSEL0`"]
    #[inline(always)]
    pub fn is_fc7_cts_sda_ssel0(&self) -> bool {
        *self == FUNC_A::FC7_CTS_SDA_SSEL0
    }
...
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO1_21_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    ...
    #[doc = "Flexcomm 7 USART clear-to-send, I2C data I/O, SPI Slave Select 0."]
    #[inline(always)]
    pub fn fc7_cts_sda_ssel0(self) -> &'a mut W {
        self.variant(FUNC_A::FC7_CTS_SDA_SSEL0)
    }
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_21_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_21_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_21_SPEC, DIGIMODE_A, O>;
