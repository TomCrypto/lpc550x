...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            ...
            2 => Some(FUNC_A::CTIMER_INP1),
            3 => Some(FUNC_A::SCT0_OUT0),
            4 => Some(FUNC_A::SCT0_GPI2),
            10 => Some(FUNC_A::SEC_PIO0_2),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `SCT0_OUT0`"]
    #[inline(always)]
    pub fn is_sct0_out0(&self) -> bool {
        *self == FUNC_A::SCT0_OUT0
    }
    ...
    #[doc = "Checks if the value of the field is `SEC_PIO0_2`"]
    #[inline(always)]
    pub fn is_sec_pio0_2(&self) -> bool {
        *self == FUNC_A::SEC_PIO0_2
    }
}
#[doc = "Field `FUNC` writer - Selects pin function."]
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO0_2_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    ...
    #[doc = "SCTimer/PWM output 0."]
    #[inline(always)]
    pub fn sct0_out0(self) -> &'a mut W {
        self.variant(FUNC_A::SCT0_OUT0)
    }
    ...
    #[doc = "Secure GPIO pin."]
    #[inline(always)]
    pub fn sec_pio0_2(self) -> &'a mut W {
        self.variant(FUNC_A::SEC_PIO0_2)
    }
}
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_2_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_2_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_2_SPEC, DIGIMODE_A, O>;
