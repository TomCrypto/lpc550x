...
pub enum FUNC_A {
    ...
    SCT0_GPI5 = 4,
    #[doc = "5: Flexcomm 4 SPI slave select 3."]
    FC4_SSEL3 = 5,
    #[doc = "7: PLU output 4."]
    PLU_OUT4 = 7,
    #[doc = "9: Receiver input for CAN0."]
    CAN0_RD = 9,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            ...
            5 => Some(FUNC_A::FC4_SSEL3),
            7 => Some(FUNC_A::PLU_OUT4),
            9 => Some(FUNC_A::CAN0_RD),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `FC4_SSEL3`"]
    #[inline(always)]
    pub fn is_fc4_ssel3(&self) -> bool {
        *self == FUNC_A::FC4_SSEL3
    }
...
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO1_22_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    ...
    #[doc = "Flexcomm 4 SPI slave select 3."]
    #[inline(always)]
    pub fn fc4_ssel3(self) -> &'a mut W {
        self.variant(FUNC_A::FC4_SSEL3)
    }
    #[doc = "PLU output 4."]
    #[inline(always)]
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_22_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_22_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_22_SPEC, DIGIMODE_A, O>;
