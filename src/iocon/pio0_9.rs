...
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General-purpose digital input/output pin. Comparator 0, input B in analog mode."]
    PIO0_9_ACMP0_B = 0,
    #[doc = "1: Flexcomm 3 SPI slave select 2."]
    FC3_SSEL2 = 1,
    #[doc = "3: Flexcomm 5 USART transmitter, I2C clock, SPI master-in/slave-out data I/O, I2S word-select/frame."]
    FC5_TXD_SCL_MISO_WS = 3,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::PIO0_9_ACMP0_B),
            1 => Some(FUNC_A::FC3_SSEL2),
            3 => Some(FUNC_A::FC5_TXD_SCL_MISO_WS),
            10 => Some(FUNC_A::SEC_PIO0_9),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `PIO0_9_ACMP0_B`"]
    #[inline(always)]
    pub fn is_pio0_9_acmp0_b(&self) -> bool {
        *self == FUNC_A::PIO0_9_ACMP0_B
    }
    #[doc = "Checks if the value of the field is `FC3_SSEL2`"]
    #[inline(always)]
    pub fn is_fc3_ssel2(&self) -> bool {
        *self == FUNC_A::FC3_SSEL2
    }
    #[doc = "Checks if the value of the field is `FC5_TXD_SCL_MISO_WS`"]
    #[inline(always)]
    pub fn is_fc5_txd_scl_miso_ws(&self) -> bool {
        *self == FUNC_A::FC5_TXD_SCL_MISO_WS
    }
    #[doc = "Checks if the value of the field is `SEC_PIO0_9`"]
    #[inline(always)]
    pub fn is_sec_pio0_9(&self) -> bool {
        *self == FUNC_A::SEC_PIO0_9
    }
}
#[doc = "Field `FUNC` writer - Selects pin function."]
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO0_9_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    #[doc = "General-purpose digital input/output pin. Comparator 0, input B in analog mode."]
    #[inline(always)]
    pub fn pio0_9_acmp0_b(self) -> &'a mut W {
        self.variant(FUNC_A::PIO0_9_ACMP0_B)
    }
    #[doc = "Flexcomm 3 SPI slave select 2."]
    #[inline(always)]
    pub fn fc3_ssel2(self) -> &'a mut W {
        self.variant(FUNC_A::FC3_SSEL2)
    }
    #[doc = "Flexcomm 5 USART transmitter, I2C clock, SPI master-in/slave-out data I/O, I2S word-select/frame."]
    #[inline(always)]
    pub fn fc5_txd_scl_miso_ws(self) -> &'a mut W {
        self.variant(FUNC_A::FC5_TXD_SCL_MISO_WS)
    }
    #[doc = "Secure GPIO pin."]
    #[inline(always)]
    pub fn sec_pio0_9(self) -> &'a mut W {
        self.variant(FUNC_A::SEC_PIO0_9)
    }
}
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_9_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_9_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_9_SPEC, DIGIMODE_A, O>;
...
pub type ASW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_9_SPEC, ASW_A, O>;
