...
pub enum FUNC_A {
    ...
    PIO0_4 = 0,
    #[doc = "1: Receiver input for CAN0."]
    CAN0_RD = 1,
    #[doc = "2: Flexcomm 4 USART, SPI or I2S clock."]
    FC4_SCK = 2,
    #[doc = "3: Capture input to CTimer input multiplexers."]
    CTIMER_INP12 = 3,
    #[doc = "4: Pin input 4 to SCTimer/PWM."]
    SCT0_GPI4 = 4,
    #[doc = "8: Flexcomm 3 USART clear-to-send, I2C data I/O, SPI Slave Select 0."]
    FC3_CTS_SDA_SSEL0 = 8,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            ...
            1 => Some(FUNC_A::CAN0_RD),
            2 => Some(FUNC_A::FC4_SCK),
            3 => Some(FUNC_A::CTIMER_INP12),
            4 => Some(FUNC_A::SCT0_GPI4),
            8 => Some(FUNC_A::FC3_CTS_SDA_SSEL0),
            10 => Some(FUNC_A::SEC_PIO0_4),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `CAN0_RD`"]
    #[inline(always)]
    pub fn is_can0_rd(&self) -> bool {
        *self == FUNC_A::CAN0_RD
    }
    #[doc = "Checks if the value of the field is `FC4_SCK`"]
    #[inline(always)]
    pub fn is_fc4_sck(&self) -> bool {
        *self == FUNC_A::FC4_SCK
    }
    #[doc = "Checks if the value of the field is `CTIMER_INP12`"]
    #[inline(always)]
    pub fn is_ctimer_inp12(&self) -> bool {
        *self == FUNC_A::CTIMER_INP12
    }
    ...
    #[doc = "Checks if the value of the field is `SEC_PIO0_4`"]
    #[inline(always)]
    pub fn is_sec_pio0_4(&self) -> bool {
        *self == FUNC_A::SEC_PIO0_4
    }
}
#[doc = "Field `FUNC` writer - Selects pin function."]
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO0_4_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    ...
    #[doc = "Receiver input for CAN0."]
    #[inline(always)]
    pub fn can0_rd(self) -> &'a mut W {
        self.variant(FUNC_A::CAN0_RD)
    }
    #[doc = "Flexcomm 4 USART, SPI or I2S clock."]
    #[inline(always)]
    pub fn fc4_sck(self) -> &'a mut W {
        self.variant(FUNC_A::FC4_SCK)
    }
    #[doc = "Capture input to CTimer input multiplexers."]
    #[inline(always)]
    pub fn ctimer_inp12(self) -> &'a mut W {
        self.variant(FUNC_A::CTIMER_INP12)
    }
    ...
    #[doc = "Secure GPIO pin."]
    #[inline(always)]
    pub fn sec_pio0_4(self) -> &'a mut W {
        self.variant(FUNC_A::SEC_PIO0_4)
    }
}
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_4_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_4_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_4_SPEC, DIGIMODE_A, O>;
