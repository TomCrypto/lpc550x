...
pub enum FUNC_A {
    ...
    PIO1_23 = 0,
    #[doc = "1: Flexcomm 2 USART, SPI or I2S clock."]
    FC2_SCK = 1,
    #[doc = "2: SCTimer/PWM output 0."]
    SCT0_OUT0 = 2,
    #[doc = "5: Flexcomm 3 SPI slave select 2."]
    FC3_SSEL2 = 5,
    #[doc = "7: PLU output 5."]
    PLU_OUT5 = 7,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            ...
            1 => Some(FUNC_A::FC2_SCK),
            2 => Some(FUNC_A::SCT0_OUT0),
            5 => Some(FUNC_A::FC3_SSEL2),
            7 => Some(FUNC_A::PLU_OUT5),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `FC2_SCK`"]
    #[inline(always)]
    pub fn is_fc2_sck(&self) -> bool {
        *self == FUNC_A::FC2_SCK
    }
...
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO1_23_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    ...
    #[doc = "Flexcomm 2 USART, SPI or I2S clock."]
    #[inline(always)]
    pub fn fc2_sck(self) -> &'a mut W {
        self.variant(FUNC_A::FC2_SCK)
    }
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_23_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_23_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_23_SPEC, DIGIMODE_A, O>;
