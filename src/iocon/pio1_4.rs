...
pub enum FUNC_A {
    ...
    FC0_SCK = 1,
    #[doc = "3: CTimer2 match output 1."]
    CTIMER2_MAT1 = 3,
    #[doc = "4: SCTimer/PWM output 0."]
    SCT0_OUT0 = 4,
    #[doc = "5: Frequency Measure pin clock input A."]
    FREQME_GPIO_CLK_A = 5,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            ...
            3 => Some(FUNC_A::CTIMER2_MAT1),
            4 => Some(FUNC_A::SCT0_OUT0),
            5 => Some(FUNC_A::FREQME_GPIO_CLK_A),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `CTIMER2_MAT1`"]
    #[inline(always)]
    pub fn is_ctimer2_mat1(&self) -> bool {
        *self == FUNC_A::CTIMER2_MAT1
    }
...
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO1_4_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    ...
    #[doc = "CTimer2 match output 1."]
    #[inline(always)]
    pub fn ctimer2_mat1(self) -> &'a mut W {
        self.variant(FUNC_A::CTIMER2_MAT1)
    }
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_4_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_4_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_4_SPEC, DIGIMODE_A, O>;
