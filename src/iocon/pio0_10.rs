...
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General-purpose digital input/output pin. ADC input channel 1 in analog mode."]
    PIO0_10_ADC0_1 = 0,
    #[doc = "1: Flexcomm 6 USART, SPI or I2S clock."]
    FC6_SCK = 1,
    #[doc = "2: Capture input to CTimer input multiplexers."]
    CTIMER_INP10 = 2,
    #[doc = "3: CTimer2 match output 0."]
    CTIMER2_MAT0 = 3,
    #[doc = "4: Flexcomm 1 USART transmitter, I2C clock, SPI master-in/slave-out data I/O, I2S word-select/frame."]
    FC1_TXD_SCL_MISO_WS = 4,
    #[doc = "5: SCTimer/PWM output 2."]
    SCT0_OUT2 = 5,
    #[doc = "6: Serial Wire Debug trace output."]
    SWO = 6,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::PIO0_10_ADC0_1),
            1 => Some(FUNC_A::FC6_SCK),
            2 => Some(FUNC_A::CTIMER_INP10),
            3 => Some(FUNC_A::CTIMER2_MAT0),
            4 => Some(FUNC_A::FC1_TXD_SCL_MISO_WS),
            5 => Some(FUNC_A::SCT0_OUT2),
            6 => Some(FUNC_A::SWO),
            10 => Some(FUNC_A::SEC_PIO0_10),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `PIO0_10_ADC0_1`"]
    #[inline(always)]
    pub fn is_pio0_10_adc0_1(&self) -> bool {
        *self == FUNC_A::PIO0_10_ADC0_1
    }
    #[doc = "Checks if the value of the field is `FC6_SCK`"]
    #[inline(always)]
    pub fn is_fc6_sck(&self) -> bool {
        *self == FUNC_A::FC6_SCK
    }
    #[doc = "Checks if the value of the field is `CTIMER_INP10`"]
    #[inline(always)]
    pub fn is_ctimer_inp10(&self) -> bool {
        *self == FUNC_A::CTIMER_INP10
    }
    #[doc = "Checks if the value of the field is `CTIMER2_MAT0`"]
    #[inline(always)]
    pub fn is_ctimer2_mat0(&self) -> bool {
        *self == FUNC_A::CTIMER2_MAT0
    }
    #[doc = "Checks if the value of the field is `FC1_TXD_SCL_MISO_WS`"]
    #[inline(always)]
    pub fn is_fc1_txd_scl_miso_ws(&self) -> bool {
        *self == FUNC_A::FC1_TXD_SCL_MISO_WS
    }
    ...
    #[doc = "Checks if the value of the field is `SEC_PIO0_10`"]
    #[inline(always)]
    pub fn is_sec_pio0_10(&self) -> bool {
        *self == FUNC_A::SEC_PIO0_10
    }
}
#[doc = "Field `FUNC` writer - Selects pin function."]
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO0_10_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    #[doc = "General-purpose digital input/output pin. ADC input channel 1 in analog mode."]
    #[inline(always)]
    pub fn pio0_10_adc0_1(self) -> &'a mut W {
        self.variant(FUNC_A::PIO0_10_ADC0_1)
    }
    #[doc = "Flexcomm 6 USART, SPI or I2S clock."]
    #[inline(always)]
    pub fn fc6_sck(self) -> &'a mut W {
        self.variant(FUNC_A::FC6_SCK)
    }
    #[doc = "Capture input to CTimer input multiplexers."]
    #[inline(always)]
    pub fn ctimer_inp10(self) -> &'a mut W {
        self.variant(FUNC_A::CTIMER_INP10)
    }
    #[doc = "CTimer2 match output 0."]
    #[inline(always)]
    pub fn ctimer2_mat0(self) -> &'a mut W {
        self.variant(FUNC_A::CTIMER2_MAT0)
    }
    #[doc = "Flexcomm 1 USART transmitter, I2C clock, SPI master-in/slave-out data I/O, I2S word-select/frame."]
    #[inline(always)]
    pub fn fc1_txd_scl_miso_ws(self) -> &'a mut W {
        self.variant(FUNC_A::FC1_TXD_SCL_MISO_WS)
    }
    ...
    #[doc = "Serial Wire Debug trace output."]
    #[inline(always)]
    ...
    #[doc = "Secure GPIO pin."]
    #[inline(always)]
    pub fn sec_pio0_10(self) -> &'a mut W {
        self.variant(FUNC_A::SEC_PIO0_10)
    }
}
...
pub type MODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, PIO0_10_SPEC, u8, MODE_A, 2, O>;
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_10_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_10_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_10_SPEC, DIGIMODE_A, O>;
...
pub type OD_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_10_SPEC, OD_A, O>;
...
pub type ASW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_10_SPEC, ASW_A, O>;
