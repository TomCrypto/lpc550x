...
pub enum FUNC_A {
    ...
    PIO0_3 = 0,
    #[doc = "1: Flexcomm 3 USART receiver, I2C data I/O, SPI master-out/slave-in data, I2S data I/O."]
    FC3_RXD_SDA_MOSI_DATA = 1,
    #[doc = "2: CTimer0 match output 1."]
    CTIMER0_MAT1 = 2,
    #[doc = "3: SCTimer/PWM output 1."]
    SCT0_OUT1 = 3,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            ...
            1 => Some(FUNC_A::FC3_RXD_SDA_MOSI_DATA),
            2 => Some(FUNC_A::CTIMER0_MAT1),
            3 => Some(FUNC_A::SCT0_OUT1),
            4 => Some(FUNC_A::SCT0_GPI3),
            10 => Some(FUNC_A::SEC_PIO0_3),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `FC3_RXD_SDA_MOSI_DATA`"]
    #[inline(always)]
    pub fn is_fc3_rxd_sda_mosi_data(&self) -> bool {
        *self == FUNC_A::FC3_RXD_SDA_MOSI_DATA
    }
    ...
    #[doc = "Checks if the value of the field is `SEC_PIO0_3`"]
    #[inline(always)]
    pub fn is_sec_pio0_3(&self) -> bool {
        *self == FUNC_A::SEC_PIO0_3
    }
}
#[doc = "Field `FUNC` writer - Selects pin function."]
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO0_3_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    ...
    #[doc = "Flexcomm 3 USART receiver, I2C data I/O, SPI master-out/slave-in data, I2S data I/O."]
    #[inline(always)]
    pub fn fc3_rxd_sda_mosi_data(self) -> &'a mut W {
        self.variant(FUNC_A::FC3_RXD_SDA_MOSI_DATA)
    }
    ...
    #[doc = "Secure GPIO pin."]
    #[inline(always)]
    pub fn sec_pio0_3(self) -> &'a mut W {
        self.variant(FUNC_A::SEC_PIO0_3)
    }
}
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_3_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_3_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_3_SPEC, DIGIMODE_A, O>;
