...
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General-purpose digital input/output pin. ADC input channel 11 in analog mode."]
    PIO1_0_ADC0_11 = 0,
    #[doc = "1: Flexcomm 0 USART request-to-send, I2C clock, SPI slave select 1."]
    FC0_RTS_SCL_SSEL1 = 1,
    #[doc = "3: Capture input to CTimer input multiplexers."]
    CTIMER_INP2 = 3,
    #[doc = "4: Pin input 4 to SCTimer/PWM."]
    SCT0_GPI4 = 4,
    #[doc = "9: PLU output 3."]
    PLU_OUT3 = 9,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::PIO1_0_ADC0_11),
            1 => Some(FUNC_A::FC0_RTS_SCL_SSEL1),
            3 => Some(FUNC_A::CTIMER_INP2),
            4 => Some(FUNC_A::SCT0_GPI4),
            9 => Some(FUNC_A::PLU_OUT3),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `PIO1_0_ADC0_11`"]
    #[inline(always)]
    pub fn is_pio1_0_adc0_11(&self) -> bool {
        *self == FUNC_A::PIO1_0_ADC0_11
    }
    #[doc = "Checks if the value of the field is `FC0_RTS_SCL_SSEL1`"]
    #[inline(always)]
    pub fn is_fc0_rts_scl_ssel1(&self) -> bool {
        *self == FUNC_A::FC0_RTS_SCL_SSEL1
    }
    #[doc = "Checks if the value of the field is `CTIMER_INP2`"]
    #[inline(always)]
    pub fn is_ctimer_inp2(&self) -> bool {
        *self == FUNC_A::CTIMER_INP2
    }
    #[doc = "Checks if the value of the field is `SCT0_GPI4`"]
    #[inline(always)]
    pub fn is_sct0_gpi4(&self) -> bool {
        *self == FUNC_A::SCT0_GPI4
    }
    #[doc = "Checks if the value of the field is `PLU_OUT3`"]
    #[inline(always)]
    pub fn is_plu_out3(&self) -> bool {
        *self == FUNC_A::PLU_OUT3
    }
}
#[doc = "Field `FUNC` writer - Selects pin function."]
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO1_0_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    #[doc = "General-purpose digital input/output pin. ADC input channel 11 in analog mode."]
    #[inline(always)]
    pub fn pio1_0_adc0_11(self) -> &'a mut W {
        self.variant(FUNC_A::PIO1_0_ADC0_11)
    }
    #[doc = "Flexcomm 0 USART request-to-send, I2C clock, SPI slave select 1."]
    #[inline(always)]
    pub fn fc0_rts_scl_ssel1(self) -> &'a mut W {
        self.variant(FUNC_A::FC0_RTS_SCL_SSEL1)
    }
    #[doc = "Capture input to CTimer input multiplexers."]
    #[inline(always)]
    pub fn ctimer_inp2(self) -> &'a mut W {
        self.variant(FUNC_A::CTIMER_INP2)
    }
    #[doc = "Pin input 4 to SCTimer/PWM."]
    #[inline(always)]
    pub fn sct0_gpi4(self) -> &'a mut W {
        self.variant(FUNC_A::SCT0_GPI4)
    }
    #[doc = "PLU output 3."]
    #[inline(always)]
    pub fn plu_out3(self) -> &'a mut W {
        self.variant(FUNC_A::PLU_OUT3)
    }
}
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_0_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_0_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_0_SPEC, DIGIMODE_A, O>;
...
pub type ASW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_0_SPEC, ASW_A, O>;
