...
pub enum FUNC_A {
    ...
    PIO0_29 = 0,
    #[doc = "1: Flexcomm 0 USART receiver, I2C data I/O, SPI master-out/slave-in data, I2S data I/O."]
    FC0_RXD_SDA_MOSI_DATA = 1,
    #[doc = "3: CTimer2 match output 3."]
    CTIMER2_MAT3 = 3,
    #[doc = "4: SCTimer/PWM output 8."]
    SCT0_OUT8 = 4,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::PIO0_29),
            1 => Some(FUNC_A::FC0_RXD_SDA_MOSI_DATA),
            3 => Some(FUNC_A::CTIMER2_MAT3),
            4 => Some(FUNC_A::SCT0_OUT8),
            7 => Some(FUNC_A::CMP0_OUT),
            9 => Some(FUNC_A::PLU_OUT2),
            10 => Some(FUNC_A::SEC_PIO0_29),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `FC0_RXD_SDA_MOSI_DATA`"]
    #[inline(always)]
    pub fn is_fc0_rxd_sda_mosi_data(&self) -> bool {
        *self == FUNC_A::FC0_RXD_SDA_MOSI_DATA
    }
    #[doc = "Checks if the value of the field is `CTIMER2_MAT3`"]
    #[inline(always)]
    pub fn is_ctimer2_mat3(&self) -> bool {
        *self == FUNC_A::CTIMER2_MAT3
    }
    #[doc = "Checks if the value of the field is `SCT0_OUT8`"]
    #[inline(always)]
    pub fn is_sct0_out8(&self) -> bool {
        *self == FUNC_A::SCT0_OUT8
    }
    ...
    #[doc = "Checks if the value of the field is `PLU_OUT2`"]
    #[inline(always)]
    pub fn is_plu_out2(&self) -> bool {
        *self == FUNC_A::PLU_OUT2
    }
    #[doc = "Checks if the value of the field is `SEC_PIO0_29`"]
    #[inline(always)]
    pub fn is_sec_pio0_29(&self) -> bool {
        *self == FUNC_A::SEC_PIO0_29
    }
}
#[doc = "Field `FUNC` writer - Selects pin function."]
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO0_29_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    #[doc = "General-purpose digital input/output pin."]
    #[inline(always)]
    pub fn pio0_29(self) -> &'a mut W {
        self.variant(FUNC_A::PIO0_29)
    }
    #[doc = "Flexcomm 0 USART receiver, I2C data I/O, SPI master-out/slave-in data, I2S data I/O."]
    #[inline(always)]
    pub fn fc0_rxd_sda_mosi_data(self) -> &'a mut W {
        self.variant(FUNC_A::FC0_RXD_SDA_MOSI_DATA)
    }
    #[doc = "CTimer2 match output 3."]
    #[inline(always)]
    pub fn ctimer2_mat3(self) -> &'a mut W {
        self.variant(FUNC_A::CTIMER2_MAT3)
    }
    #[doc = "SCTimer/PWM output 8."]
    #[inline(always)]
    pub fn sct0_out8(self) -> &'a mut W {
        self.variant(FUNC_A::SCT0_OUT8)
    }
    ...
    #[doc = "PLU output 2."]
    #[inline(always)]
    pub fn plu_out2(self) -> &'a mut W {
        self.variant(FUNC_A::PLU_OUT2)
    }
    #[doc = "Secure GPIO pin."]
    #[inline(always)]
    pub fn sec_pio0_29(self) -> &'a mut W {
        self.variant(FUNC_A::SEC_PIO0_29)
    }
}
...
pub type MODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, PIO0_29_SPEC, u8, MODE_A, 2, O>;
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_29_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_29_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_29_SPEC, DIGIMODE_A, O>;
...
pub type OD_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_29_SPEC, OD_A, O>;
