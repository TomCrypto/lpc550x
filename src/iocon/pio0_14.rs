...
pub enum FUNC_A {
    ...
    PIO0_14 = 0,
    #[doc = "1: Flexcomm 1 USART request-to-send, I2C clock, SPI slave select 1."]
    FC1_RTS_SCL_SSEL1 = 1,
    #[doc = "2: Micro-tick timer capture input 1."]
    UTICK_CAP1 = 2,
    #[doc = "3: Capture input to CTimer input multiplexers."]
    CTIMER_INP1 = 3,
    #[doc = "4: Pin input 1 to SCTimer/PWM."]
    SCT0_GPI1 = 4,
    #[doc = "6: Flexcomm 1 USART transmitter, I2C clock, SPI master-in/slave-out data I/O, I2S word-select/frame."]
    FC1_TXD_SCL_MISO_WS = 6,
    #[doc = "9: PLU input 1."]
    PLU_INPUT1 = 9,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::PIO0_14),
            1 => Some(FUNC_A::FC1_RTS_SCL_SSEL1),
            2 => Some(FUNC_A::UTICK_CAP1),
            3 => Some(FUNC_A::CTIMER_INP1),
            4 => Some(FUNC_A::SCT0_GPI1),
            6 => Some(FUNC_A::FC1_TXD_SCL_MISO_WS),
            9 => Some(FUNC_A::PLU_INPUT1),
            10 => Some(FUNC_A::SEC_PIO0_14),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `FC1_RTS_SCL_SSEL1`"]
    #[inline(always)]
    pub fn is_fc1_rts_scl_ssel1(&self) -> bool {
        *self == FUNC_A::FC1_RTS_SCL_SSEL1
    }
    #[doc = "Checks if the value of the field is `UTICK_CAP1`"]
    #[inline(always)]
    pub fn is_utick_cap1(&self) -> bool {
        *self == FUNC_A::UTICK_CAP1
    }
    #[doc = "Checks if the value of the field is `CTIMER_INP1`"]
    #[inline(always)]
    pub fn is_ctimer_inp1(&self) -> bool {
        *self == FUNC_A::CTIMER_INP1
    }
    ...
    #[doc = "Checks if the value of the field is `PLU_INPUT1`"]
    #[inline(always)]
    pub fn is_plu_input1(&self) -> bool {
        *self == FUNC_A::PLU_INPUT1
    }
    #[doc = "Checks if the value of the field is `SEC_PIO0_14`"]
    #[inline(always)]
    pub fn is_sec_pio0_14(&self) -> bool {
        *self == FUNC_A::SEC_PIO0_14
    }
}
#[doc = "Field `FUNC` writer - Selects pin function."]
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO0_14_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    ...
    #[doc = "Flexcomm 1 USART request-to-send, I2C clock, SPI slave select 1."]
    #[inline(always)]
    pub fn fc1_rts_scl_ssel1(self) -> &'a mut W {
        self.variant(FUNC_A::FC1_RTS_SCL_SSEL1)
    }
    #[doc = "Micro-tick timer capture input 1."]
    #[inline(always)]
    pub fn utick_cap1(self) -> &'a mut W {
        self.variant(FUNC_A::UTICK_CAP1)
    }
    #[doc = "Capture input to CTimer input multiplexers."]
    #[inline(always)]
    pub fn ctimer_inp1(self) -> &'a mut W {
        self.variant(FUNC_A::CTIMER_INP1)
    }
    ...
    #[doc = "PLU input 1."]
    #[inline(always)]
    pub fn plu_input1(self) -> &'a mut W {
        self.variant(FUNC_A::PLU_INPUT1)
    }
    #[doc = "Secure GPIO pin."]
    #[inline(always)]
    pub fn sec_pio0_14(self) -> &'a mut W {
        self.variant(FUNC_A::SEC_PIO0_14)
    }
}
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_14_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_14_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_14_SPEC, DIGIMODE_A, O>;
...
pub type SSEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_14_SPEC, SSEL_A, O>;
...
pub type FILTEROFF_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_14_SPEC, FILTEROFF_A, O>;
...
pub type ECS_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_14_SPEC, ECS_A, O>;
...
pub type EGP_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_14_SPEC, EGP_A, O>;
...
pub type I2CFILTER_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_14_SPEC, I2CFILTER_A, O>;
