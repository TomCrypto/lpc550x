...
pub enum FUNC_A {
    ...
    #[doc = "2: SCTimer/PWM output 2."]
    SCT0_OUT2 = 2,
    #[doc = "4: Micro-tick timer capture input 0."]
    UTICK_CAP0 = 4,
    #[doc = "7: PLU clock input."]
    PLU_CLKIN = 7,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            ...
            2 => Some(FUNC_A::SCT0_OUT2),
            4 => Some(FUNC_A::UTICK_CAP0),
            7 => Some(FUNC_A::PLU_CLKIN),
            _ => None,
        }
    }
...
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO1_25_SPEC, u8, FUNC_A, 4, O>;
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_25_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_25_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_25_SPEC, DIGIMODE_A, O>;
