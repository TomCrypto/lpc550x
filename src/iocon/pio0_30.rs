...
pub enum FUNC_A {
    ...
    PIO0_30 = 0,
    #[doc = "1: Flexcomm 0 USART transmitter, I2C clock, SPI master-in/slave-out data I/O, I2S word-select/frame."]
    FC0_TXD_SCL_MISO_WS = 1,
    #[doc = "3: CTimer0 match output 0."]
    CTIMER0_MAT0 = 3,
    #[doc = "4: SCTimer/PWM output 9."]
    SCT0_OUT9 = 4,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::PIO0_30),
            1 => Some(FUNC_A::FC0_TXD_SCL_MISO_WS),
            3 => Some(FUNC_A::CTIMER0_MAT0),
            4 => Some(FUNC_A::SCT0_OUT9),
            10 => Some(FUNC_A::SEC_PIO0_30),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `PIO0_30`"]
    #[inline(always)]
    pub fn is_pio0_30(&self) -> bool {
        *self == FUNC_A::PIO0_30
    }
    #[doc = "Checks if the value of the field is `FC0_TXD_SCL_MISO_WS`"]
    #[inline(always)]
    pub fn is_fc0_txd_scl_miso_ws(&self) -> bool {
        *self == FUNC_A::FC0_TXD_SCL_MISO_WS
    }
    ...
    #[doc = "Checks if the value of the field is `SCT0_OUT9`"]
    #[inline(always)]
    pub fn is_sct0_out9(&self) -> bool {
        *self == FUNC_A::SCT0_OUT9
    }
    #[doc = "Checks if the value of the field is `SEC_PIO0_30`"]
    #[inline(always)]
    pub fn is_sec_pio0_30(&self) -> bool {
        *self == FUNC_A::SEC_PIO0_30
    }
}
#[doc = "Field `FUNC` writer - Selects pin function."]
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO0_30_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    #[doc = "General-purpose digital input/output pin."]
    #[inline(always)]
    pub fn pio0_30(self) -> &'a mut W {
        self.variant(FUNC_A::PIO0_30)
    }
    #[doc = "Flexcomm 0 USART transmitter, I2C clock, SPI master-in/slave-out data I/O, I2S word-select/frame."]
    #[inline(always)]
    pub fn fc0_txd_scl_miso_ws(self) -> &'a mut W {
        self.variant(FUNC_A::FC0_TXD_SCL_MISO_WS)
    }
    ...
    #[doc = "SCTimer/PWM output 9."]
    #[inline(always)]
    pub fn sct0_out9(self) -> &'a mut W {
        self.variant(FUNC_A::SCT0_OUT9)
    }
    #[doc = "Secure GPIO pin."]
    #[inline(always)]
    pub fn sec_pio0_30(self) -> &'a mut W {
        self.variant(FUNC_A::SEC_PIO0_30)
    }
}
...
pub type MODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, PIO0_30_SPEC, u8, MODE_A, 2, O>;
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_30_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_30_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_30_SPEC, DIGIMODE_A, O>;
...
pub type OD_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_30_SPEC, OD_A, O>;
