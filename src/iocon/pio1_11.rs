...
pub enum FUNC_A {
    ...
    PIO1_11 = 0,
    #[doc = "2: Flexcomm 1 USART transmitter, I2C clock, SPI master-in/slave-out data I/O, I2S word-select/frame."]
    FC1_TXD_SCL_MISO_WS = 2,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            ...
            2 => Some(FUNC_A::FC1_TXD_SCL_MISO_WS),
            3 => Some(FUNC_A::CTIMER_INP5),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `CTIMER_INP5`"]
    #[inline(always)]
    pub fn is_ctimer_inp5(&self) -> bool {
        *self == FUNC_A::CTIMER_INP5
    }
}
#[doc = "Field `FUNC` writer - Selects pin function."]
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO1_11_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    ...
    #[inline(always)]
    pub fn ctimer_inp5(self) -> &'a mut W {
        self.variant(FUNC_A::CTIMER_INP5)
    }
}
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_11_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_11_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_11_SPEC, DIGIMODE_A, O>;
