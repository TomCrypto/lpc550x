...
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General-purpose digital input/output pin. ADC input channel 2 in analog mode."]
    PIO0_15_ADC0_2 = 0,
    #[doc = "1: Flexcomm 6 USART clear-to-send, I2C data I/O, SPI Slave Select 0."]
    FC6_CTS_SDA_SSEL0 = 1,
    #[doc = "2: Micro-tick timer capture input 2."]
    UTICK_CAP2 = 2,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::PIO0_15_ADC0_2),
            1 => Some(FUNC_A::FC6_CTS_SDA_SSEL0),
            2 => Some(FUNC_A::UTICK_CAP2),
            3 => Some(FUNC_A::CTIMER_INP16),
            4 => Some(FUNC_A::SCT0_OUT2),
            10 => Some(FUNC_A::SEC_PIO0_15),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `PIO0_15_ADC0_2`"]
    #[inline(always)]
    pub fn is_pio0_15_adc0_2(&self) -> bool {
        *self == FUNC_A::PIO0_15_ADC0_2
    }
    #[doc = "Checks if the value of the field is `FC6_CTS_SDA_SSEL0`"]
    #[inline(always)]
    pub fn is_fc6_cts_sda_ssel0(&self) -> bool {
        *self == FUNC_A::FC6_CTS_SDA_SSEL0
    }
    #[doc = "Checks if the value of the field is `UTICK_CAP2`"]
    #[inline(always)]
    pub fn is_utick_cap2(&self) -> bool {
        *self == FUNC_A::UTICK_CAP2
    }
    #[doc = "Checks if the value of the field is `CTIMER_INP16`"]
    #[inline(always)]
    pub fn is_ctimer_inp16(&self) -> bool {
        *self == FUNC_A::CTIMER_INP16
    }
    ...
    #[doc = "Checks if the value of the field is `SEC_PIO0_15`"]
    #[inline(always)]
    pub fn is_sec_pio0_15(&self) -> bool {
        *self == FUNC_A::SEC_PIO0_15
    }
}
#[doc = "Field `FUNC` writer - Selects pin function."]
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO0_15_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    #[doc = "General-purpose digital input/output pin. ADC input channel 2 in analog mode."]
    #[inline(always)]
    pub fn pio0_15_adc0_2(self) -> &'a mut W {
        self.variant(FUNC_A::PIO0_15_ADC0_2)
    }
    #[doc = "Flexcomm 6 USART clear-to-send, I2C data I/O, SPI Slave Select 0."]
    #[inline(always)]
    pub fn fc6_cts_sda_ssel0(self) -> &'a mut W {
        self.variant(FUNC_A::FC6_CTS_SDA_SSEL0)
    }
    #[doc = "Micro-tick timer capture input 2."]
    #[inline(always)]
    pub fn utick_cap2(self) -> &'a mut W {
        self.variant(FUNC_A::UTICK_CAP2)
    }
    #[doc = "Capture input to CTimer input multiplexers."]
    #[inline(always)]
    pub fn ctimer_inp16(self) -> &'a mut W {
        self.variant(FUNC_A::CTIMER_INP16)
    }
    ...
    #[doc = "Secure GPIO pin."]
    #[inline(always)]
    pub fn sec_pio0_15(self) -> &'a mut W {
        self.variant(FUNC_A::SEC_PIO0_15)
    }
}
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_15_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_15_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_15_SPEC, DIGIMODE_A, O>;
...
pub type ASW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_15_SPEC, ASW_A, O>;
