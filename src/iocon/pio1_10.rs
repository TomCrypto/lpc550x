...
pub enum FUNC_A {
    ...
    PIO1_10 = 0,
    #[doc = "2: Flexcomm 1 USART receiver, I2C data I/O, SPI master-out/slave-in data, I2S data I/O."]
    FC1_RXD_SDA_MOSI_DATA = 2,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            ...
            2 => Some(FUNC_A::FC1_RXD_SDA_MOSI_DATA),
...
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO1_10_SPEC, u8, FUNC_A, 4, O>;
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_10_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_10_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_10_SPEC, DIGIMODE_A, O>;
