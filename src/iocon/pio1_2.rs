...
pub enum FUNC_A {
    ...
    CAN0_TD = 1,
    #[doc = "3: CTimer0 match output 3."]
    CTIMER0_MAT3 = 3,
    #[doc = "4: Pin input 6 to SCTimer/PWM."]
    SCT0_GPI6 = 4,
    #[doc = "6: Clock for high-speed SPI."]
    HS_SPI_SCK = 6,
    #[doc = "9: PLU output 5."]
    PLU_OUT5 = 9,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            ...
            3 => Some(FUNC_A::CTIMER0_MAT3),
            4 => Some(FUNC_A::SCT0_GPI6),
            6 => Some(FUNC_A::HS_SPI_SCK),
            9 => Some(FUNC_A::PLU_OUT5),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `CTIMER0_MAT3`"]
    #[inline(always)]
    pub fn is_ctimer0_mat3(&self) -> bool {
        *self == FUNC_A::CTIMER0_MAT3
    }
    ...
    #[doc = "Checks if the value of the field is `HS_SPI_SCK`"]
    #[inline(always)]
    pub fn is_hs_spi_sck(&self) -> bool {
        *self == FUNC_A::HS_SPI_SCK
    }
    #[doc = "Checks if the value of the field is `PLU_OUT5`"]
    #[inline(always)]
    pub fn is_plu_out5(&self) -> bool {
        *self == FUNC_A::PLU_OUT5
    }
}
#[doc = "Field `FUNC` writer - Selects pin function."]
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO1_2_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    ...
    #[doc = "CTimer0 match output 3."]
    #[inline(always)]
    pub fn ctimer0_mat3(self) -> &'a mut W {
        self.variant(FUNC_A::CTIMER0_MAT3)
    }
    ...
    #[doc = "Clock for high-speed SPI."]
    #[inline(always)]
    pub fn hs_spi_sck(self) -> &'a mut W {
        self.variant(FUNC_A::HS_SPI_SCK)
    }
    #[doc = "PLU output 5."]
    #[inline(always)]
    pub fn plu_out5(self) -> &'a mut W {
        self.variant(FUNC_A::PLU_OUT5)
    }
}
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_2_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_2_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_2_SPEC, DIGIMODE_A, O>;
