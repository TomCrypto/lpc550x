...
pub enum FUNC_A {
    ...
    PIO0_21 = 0,
    #[doc = "1: Flexcomm 3 USART request-to-send, I2C clock, SPI slave select 1."]
    FC3_RTS_SCL_SSEL1 = 1,
    #[doc = "2: Micro-tick timer capture input 3."]
    UTICK_CAP3 = 2,
    #[doc = "3: CTimer3 match output 3."]
    CTIMER3_MAT3 = 3,
    #[doc = "4: Pin input 3 to SCTimer/PWM."]
    SCT0_GPI3 = 4,
    #[doc = "7: Flexcomm 7 USART, SPI or I2S clock."]
    FC7_SCK = 7,
    #[doc = "8: Slave Select 3 for high-speed SPI."]
    HS_SPI_SSEL3 = 8,
    #[doc = "9: PLU clock input."]
    PLU_CLKIN = 9,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            ...
            1 => Some(FUNC_A::FC3_RTS_SCL_SSEL1),
            2 => Some(FUNC_A::UTICK_CAP3),
            3 => Some(FUNC_A::CTIMER3_MAT3),
            4 => Some(FUNC_A::SCT0_GPI3),
            7 => Some(FUNC_A::FC7_SCK),
            8 => Some(FUNC_A::HS_SPI_SSEL3),
            9 => Some(FUNC_A::PLU_CLKIN),
            10 => Some(FUNC_A::SEC_PIO0_21),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `FC3_RTS_SCL_SSEL1`"]
    #[inline(always)]
    pub fn is_fc3_rts_scl_ssel1(&self) -> bool {
        *self == FUNC_A::FC3_RTS_SCL_SSEL1
    }
    #[doc = "Checks if the value of the field is `UTICK_CAP3`"]
    #[inline(always)]
    pub fn is_utick_cap3(&self) -> bool {
        *self == FUNC_A::UTICK_CAP3
    }
    #[doc = "Checks if the value of the field is `CTIMER3_MAT3`"]
    #[inline(always)]
    pub fn is_ctimer3_mat3(&self) -> bool {
        *self == FUNC_A::CTIMER3_MAT3
    }
    #[doc = "Checks if the value of the field is `SCT0_GPI3`"]
    #[inline(always)]
    pub fn is_sct0_gpi3(&self) -> bool {
        *self == FUNC_A::SCT0_GPI3
    }
    #[doc = "Checks if the value of the field is `FC7_SCK`"]
    #[inline(always)]
    pub fn is_fc7_sck(&self) -> bool {
        *self == FUNC_A::FC7_SCK
    }
    #[doc = "Checks if the value of the field is `HS_SPI_SSEL3`"]
    #[inline(always)]
    pub fn is_hs_spi_ssel3(&self) -> bool {
        *self == FUNC_A::HS_SPI_SSEL3
    }
    #[doc = "Checks if the value of the field is `PLU_CLKIN`"]
    #[inline(always)]
    pub fn is_plu_clkin(&self) -> bool {
        *self == FUNC_A::PLU_CLKIN
    }
    #[doc = "Checks if the value of the field is `SEC_PIO0_21`"]
    #[inline(always)]
    pub fn is_sec_pio0_21(&self) -> bool {
        *self == FUNC_A::SEC_PIO0_21
    }
}
#[doc = "Field `FUNC` writer - Selects pin function."]
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO0_21_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    ...
    #[doc = "Flexcomm 3 USART request-to-send, I2C clock, SPI slave select 1."]
    #[inline(always)]
    pub fn fc3_rts_scl_ssel1(self) -> &'a mut W {
        self.variant(FUNC_A::FC3_RTS_SCL_SSEL1)
    }
    #[doc = "Micro-tick timer capture input 3."]
    #[inline(always)]
    pub fn utick_cap3(self) -> &'a mut W {
        self.variant(FUNC_A::UTICK_CAP3)
    }
    #[doc = "CTimer3 match output 3."]
    #[inline(always)]
    pub fn ctimer3_mat3(self) -> &'a mut W {
        self.variant(FUNC_A::CTIMER3_MAT3)
    }
    #[doc = "Pin input 3 to SCTimer/PWM."]
    #[inline(always)]
    pub fn sct0_gpi3(self) -> &'a mut W {
        self.variant(FUNC_A::SCT0_GPI3)
    }
    #[doc = "Flexcomm 7 USART, SPI or I2S clock."]
    #[inline(always)]
    pub fn fc7_sck(self) -> &'a mut W {
        self.variant(FUNC_A::FC7_SCK)
    }
    #[doc = "Slave Select 3 for high-speed SPI."]
    #[inline(always)]
    pub fn hs_spi_ssel3(self) -> &'a mut W {
        self.variant(FUNC_A::HS_SPI_SSEL3)
    }
    #[doc = "PLU clock input."]
    #[inline(always)]
    pub fn plu_clkin(self) -> &'a mut W {
        self.variant(FUNC_A::PLU_CLKIN)
    }
    #[doc = "Secure GPIO pin."]
    #[inline(always)]
    pub fn sec_pio0_21(self) -> &'a mut W {
        self.variant(FUNC_A::SEC_PIO0_21)
    }
}
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_21_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_21_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_21_SPEC, DIGIMODE_A, O>;
