...
pub enum FUNC_A {
    ...
    FC3_RTS_SCL_SSEL1 = 1,
    #[doc = "3: Flexcomm 5 USART, SPI or I2S clock."]
    FC5_SCK = 3,
    #[doc = "4: Flexcomm 1 USART, SPI or I2S clock."]
    FC1_SCK = 4,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            ...
            3 => Some(FUNC_A::FC5_SCK),
            4 => Some(FUNC_A::FC1_SCK),
            10 => Some(FUNC_A::SEC_PIO0_7),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `FC5_SCK`"]
    #[inline(always)]
    pub fn is_fc5_sck(&self) -> bool {
        *self == FUNC_A::FC5_SCK
    }
    ...
    #[doc = "Checks if the value of the field is `SEC_PIO0_7`"]
    #[inline(always)]
    pub fn is_sec_pio0_7(&self) -> bool {
        *self == FUNC_A::SEC_PIO0_7
    }
}
#[doc = "Field `FUNC` writer - Selects pin function."]
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO0_7_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    ...
    #[doc = "Flexcomm 5 USART, SPI or I2S clock."]
    #[inline(always)]
    pub fn fc5_sck(self) -> &'a mut W {
        self.variant(FUNC_A::FC5_SCK)
    }
    ...
    #[doc = "Secure GPIO pin."]
    #[inline(always)]
    pub fn sec_pio0_7(self) -> &'a mut W {
        self.variant(FUNC_A::SEC_PIO0_7)
    }
}
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_7_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_7_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_7_SPEC, DIGIMODE_A, O>;
