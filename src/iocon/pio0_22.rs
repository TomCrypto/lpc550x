...
pub enum FUNC_A {
    ...
    PIO0_22 = 0,
    #[doc = "1: Flexcomm 6 USART transmitter, I2C clock, SPI master-in/slave-out data I/O, I2S word-select/frame."]
    FC6_TXD_SCL_MISO_WS = 1,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            ...
            1 => Some(FUNC_A::FC6_TXD_SCL_MISO_WS),
            2 => Some(FUNC_A::UTICK_CAP1),
            3 => Some(FUNC_A::CTIMER_INP15),
            4 => Some(FUNC_A::SCT0_OUT3),
            9 => Some(FUNC_A::PLU_OUT7),
            10 => Some(FUNC_A::SEC_PIO0_22),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `PLU_OUT7`"]
    #[inline(always)]
    pub fn is_plu_out7(&self) -> bool {
        *self == FUNC_A::PLU_OUT7
    }
    #[doc = "Checks if the value of the field is `SEC_PIO0_22`"]
    #[inline(always)]
    pub fn is_sec_pio0_22(&self) -> bool {
        *self == FUNC_A::SEC_PIO0_22
    }
}
#[doc = "Field `FUNC` writer - Selects pin function."]
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO0_22_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    ...
    #[doc = "PLU output 7."]
    #[inline(always)]
    pub fn plu_out7(self) -> &'a mut W {
        self.variant(FUNC_A::PLU_OUT7)
    }
    #[doc = "Secure GPIO pin."]
    #[inline(always)]
    pub fn sec_pio0_22(self) -> &'a mut W {
        self.variant(FUNC_A::SEC_PIO0_22)
    }
}
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_22_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_22_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_22_SPEC, DIGIMODE_A, O>;
