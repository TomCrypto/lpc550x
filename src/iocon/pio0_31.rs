...
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General-purpose digital input/output pin. ADC input channel 3 in analog mode."]
    PIO0_31_ADC0_3 = 0,
    #[doc = "1: Flexcomm 0 USART clear-to-send, I2C data I/O, SPI Slave Select 0."]
    FC0_CTS_SDA_SSEL0 = 1,
    #[doc = "3: CTimer0 match output 1."]
    CTIMER0_MAT1 = 3,
    #[doc = "4: SCTimer/PWM output 3."]
    SCT0_OUT3 = 4,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::PIO0_31_ADC0_3),
            1 => Some(FUNC_A::FC0_CTS_SDA_SSEL0),
            3 => Some(FUNC_A::CTIMER0_MAT1),
            4 => Some(FUNC_A::SCT0_OUT3),
            10 => Some(FUNC_A::SEC_PIO0_31),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `PIO0_31_ADC0_3`"]
    #[inline(always)]
    pub fn is_pio0_31_adc0_3(&self) -> bool {
        *self == FUNC_A::PIO0_31_ADC0_3
    }
    ...
    #[doc = "Checks if the value of the field is `CTIMER0_MAT1`"]
    #[inline(always)]
    pub fn is_ctimer0_mat1(&self) -> bool {
        *self == FUNC_A::CTIMER0_MAT1
    }
    #[doc = "Checks if the value of the field is `SCT0_OUT3`"]
    #[inline(always)]
    pub fn is_sct0_out3(&self) -> bool {
        *self == FUNC_A::SCT0_OUT3
    }
    #[doc = "Checks if the value of the field is `SEC_PIO0_31`"]
    #[inline(always)]
    pub fn is_sec_pio0_31(&self) -> bool {
        *self == FUNC_A::SEC_PIO0_31
    }
}
#[doc = "Field `FUNC` writer - Selects pin function."]
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO0_31_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    #[doc = "General-purpose digital input/output pin. ADC input channel 3 in analog mode."]
    #[inline(always)]
    pub fn pio0_31_adc0_3(self) -> &'a mut W {
        self.variant(FUNC_A::PIO0_31_ADC0_3)
    }
    ...
    #[doc = "CTimer0 match output 1."]
    #[inline(always)]
    pub fn ctimer0_mat1(self) -> &'a mut W {
        self.variant(FUNC_A::CTIMER0_MAT1)
    }
    #[doc = "SCTimer/PWM output 3."]
    #[inline(always)]
    pub fn sct0_out3(self) -> &'a mut W {
        self.variant(FUNC_A::SCT0_OUT3)
    }
    #[doc = "Secure GPIO pin."]
    #[inline(always)]
    pub fn sec_pio0_31(self) -> &'a mut W {
        self.variant(FUNC_A::SEC_PIO0_31)
    }
}
...
pub type MODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, PIO0_31_SPEC, u8, MODE_A, 2, O>;
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_31_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_31_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_31_SPEC, DIGIMODE_A, O>;
...
pub type OD_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_31_SPEC, OD_A, O>;
...
pub type ASW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_31_SPEC, ASW_A, O>;
