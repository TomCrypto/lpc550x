...
pub enum FUNC_A {
    ...
    PIO0_6 = 0,
    #[doc = "1: Flexcomm 3 USART, SPI or I2S clock."]
    FC3_SCK = 1,
    #[doc = "2: Capture input to CTimer input multiplexers."]
    CTIMER_INP13 = 2,
    #[doc = "3: CTimer4 match output 0."]
    CTIMER4_MAT0 = 3,
    #[doc = "4: Pin input 6 to SCTimer/PWM."]
    SCT0_GPI6 = 4,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            ...
            1 => Some(FUNC_A::FC3_SCK),
            2 => Some(FUNC_A::CTIMER_INP13),
            3 => Some(FUNC_A::CTIMER4_MAT0),
            4 => Some(FUNC_A::SCT0_GPI6),
            10 => Some(FUNC_A::SEC_PIO0_6),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `CTIMER_INP13`"]
    #[inline(always)]
    pub fn is_ctimer_inp13(&self) -> bool {
        *self == FUNC_A::CTIMER_INP13
    }
    #[doc = "Checks if the value of the field is `CTIMER4_MAT0`"]
    #[inline(always)]
    pub fn is_ctimer4_mat0(&self) -> bool {
        *self == FUNC_A::CTIMER4_MAT0
    }
    #[doc = "Checks if the value of the field is `SCT0_GPI6`"]
    #[inline(always)]
    pub fn is_sct0_gpi6(&self) -> bool {
        *self == FUNC_A::SCT0_GPI6
    }
    #[doc = "Checks if the value of the field is `SEC_PIO0_6`"]
    #[inline(always)]
    pub fn is_sec_pio0_6(&self) -> bool {
        *self == FUNC_A::SEC_PIO0_6
    }
}
#[doc = "Field `FUNC` writer - Selects pin function."]
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO0_6_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    ...
    #[inline(always)]
    pub fn ctimer_inp13(self) -> &'a mut W {
        self.variant(FUNC_A::CTIMER_INP13)
    }
    #[doc = "CTimer4 match output 0."]
    #[inline(always)]
    pub fn ctimer4_mat0(self) -> &'a mut W {
        self.variant(FUNC_A::CTIMER4_MAT0)
    }
    #[doc = "Pin input 6 to SCTimer/PWM."]
    #[inline(always)]
    pub fn sct0_gpi6(self) -> &'a mut W {
        self.variant(FUNC_A::SCT0_GPI6)
    }
    #[doc = "Secure GPIO pin."]
    #[inline(always)]
    pub fn sec_pio0_6(self) -> &'a mut W {
        self.variant(FUNC_A::SEC_PIO0_6)
    }
}
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_6_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_6_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_6_SPEC, DIGIMODE_A, O>;
