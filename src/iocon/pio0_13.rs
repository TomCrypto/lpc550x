...
pub enum FUNC_A {
    ...
    PIO0_13 = 0,
    #[doc = "1: Flexcomm 1 USART clear-to-send, I2C data I/O, SPI Slave Select 0."]
    FC1_CTS_SDA_SSEL0 = 1,
    ...
    SCT0_GPI0 = 4,
    #[doc = "5: Flexcomm 1 USART receiver, I2C data I/O, SPI master-out/slave-in data, I2S data I/O."]
    FC1_RXD_SDA_MOSI_DATA = 5,
    #[doc = "9: PLU input 0."]
    PLU_INPUT0 = 9,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::PIO0_13),
            1 => Some(FUNC_A::FC1_CTS_SDA_SSEL0),
            2 => Some(FUNC_A::UTICK_CAP0),
            3 => Some(FUNC_A::CTIMER_INP0),
            4 => Some(FUNC_A::SCT0_GPI0),
            5 => Some(FUNC_A::FC1_RXD_SDA_MOSI_DATA),
            9 => Some(FUNC_A::PLU_INPUT0),
            10 => Some(FUNC_A::SEC_PIO0_13),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `FC1_CTS_SDA_SSEL0`"]
    #[inline(always)]
    pub fn is_fc1_cts_sda_ssel0(&self) -> bool {
        *self == FUNC_A::FC1_CTS_SDA_SSEL0
    }
    ...
    #[doc = "Checks if the value of the field is `FC1_RXD_SDA_MOSI_DATA`"]
    #[inline(always)]
    pub fn is_fc1_rxd_sda_mosi_data(&self) -> bool {
        *self == FUNC_A::FC1_RXD_SDA_MOSI_DATA
    }
    #[doc = "Checks if the value of the field is `PLU_INPUT0`"]
    #[inline(always)]
    pub fn is_plu_input0(&self) -> bool {
        *self == FUNC_A::PLU_INPUT0
    }
    #[doc = "Checks if the value of the field is `SEC_PIO0_13`"]
    #[inline(always)]
    pub fn is_sec_pio0_13(&self) -> bool {
        *self == FUNC_A::SEC_PIO0_13
    }
}
...
impl<'a, const O: u8> FUNC_W<'a, O> {
    ...
    #[doc = "Flexcomm 1 USART clear-to-send, I2C data I/O, SPI Slave Select 0."]
    #[inline(always)]
    pub fn fc1_cts_sda_ssel0(self) -> &'a mut W {
        self.variant(FUNC_A::FC1_CTS_SDA_SSEL0)
    }
    ...
    #[doc = "Flexcomm 1 USART receiver, I2C data I/O, SPI master-out/slave-in data, I2S data I/O."]
    #[inline(always)]
    pub fn fc1_rxd_sda_mosi_data(self) -> &'a mut W {
        self.variant(FUNC_A::FC1_RXD_SDA_MOSI_DATA)
    }
    #[doc = "PLU input 0."]
    #[inline(always)]
    pub fn plu_input0(self) -> &'a mut W {
        self.variant(FUNC_A::PLU_INPUT0)
    }
    #[doc = "Secure GPIO pin."]
    #[inline(always)]
    pub fn sec_pio0_13(self) -> &'a mut W {
        self.variant(FUNC_A::SEC_PIO0_13)
    }
}
