...
pub enum FUNC_A {
    ...
    PIO1_29 = 0,
    #[doc = "1: Flexcomm 7 USART receiver, I2C data I/O, SPI master-out/slave-in data, I2S data I/O."]
    FC7_RXD_SDA_MOSI_DATA = 1,
    #[doc = "3: Pin input 6 to SCTimer/PWM."]
    SCT0_GPI6 = 3,
    #[doc = "7: PLU input 2."]
    PLU_INPUT2 = 7,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            ...
            1 => Some(FUNC_A::FC7_RXD_SDA_MOSI_DATA),
            3 => Some(FUNC_A::SCT0_GPI6),
            7 => Some(FUNC_A::PLU_INPUT2),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `PLU_INPUT2`"]
    #[inline(always)]
    pub fn is_plu_input2(&self) -> bool {
        *self == FUNC_A::PLU_INPUT2
    }
}
#[doc = "Field `FUNC` writer - Selects pin function."]
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO1_29_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    ...
    #[doc = "PLU input 2."]
    #[inline(always)]
    pub fn plu_input2(self) -> &'a mut W {
        self.variant(FUNC_A::PLU_INPUT2)
    }
}
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_29_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_29_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO1_29_SPEC, DIGIMODE_A, O>;
