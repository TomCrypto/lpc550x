...
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General-purpose digital input/output pin. ADC input channel 10 in analog mode."]
    PIO0_12_ADC0_10 = 0,
    #[doc = "1: Flexcomm 3 USART transmitter, I2C clock, SPI master-in/slave-out data I/O, I2S word-select/frame."]
    FC3_TXD_SCL_MISO_WS = 1,
    #[doc = "3: Frequency Measure pin clock input B."]
    FREQME_GPIO_CLK_B = 3,
    #[doc = "4: Pin input 7 to SCTimer/PWM."]
    SCT0_GPI7 = 4,
    #[doc = "6: Serial Debug Wire I/O."]
    SWDIO = 6,
    #[doc = "7: Flexcomm 6 USART transmitter, I2C clock, SPI master-in/slave-out data I/O, I2S word-select/frame."]
    FC6_TXD_SCL_MISO_WS = 7,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::PIO0_12_ADC0_10),
            1 => Some(FUNC_A::FC3_TXD_SCL_MISO_WS),
            3 => Some(FUNC_A::FREQME_GPIO_CLK_B),
            4 => Some(FUNC_A::SCT0_GPI7),
            6 => Some(FUNC_A::SWDIO),
            7 => Some(FUNC_A::FC6_TXD_SCL_MISO_WS),
            10 => Some(FUNC_A::SEC_PIO0_12),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `PIO0_12_ADC0_10`"]
    #[inline(always)]
    pub fn is_pio0_12_adc0_10(&self) -> bool {
        *self == FUNC_A::PIO0_12_ADC0_10
    }
    #[doc = "Checks if the value of the field is `FC3_TXD_SCL_MISO_WS`"]
    #[inline(always)]
    pub fn is_fc3_txd_scl_miso_ws(&self) -> bool {
        *self == FUNC_A::FC3_TXD_SCL_MISO_WS
    }
    #[doc = "Checks if the value of the field is `FREQME_GPIO_CLK_B`"]
    #[inline(always)]
    pub fn is_freqme_gpio_clk_b(&self) -> bool {
        *self == FUNC_A::FREQME_GPIO_CLK_B
    }
    #[doc = "Checks if the value of the field is `SCT0_GPI7`"]
    #[inline(always)]
    pub fn is_sct0_gpi7(&self) -> bool {
        *self == FUNC_A::SCT0_GPI7
    }
    ...
    #[doc = "Checks if the value of the field is `FC6_TXD_SCL_MISO_WS`"]
    #[inline(always)]
    pub fn is_fc6_txd_scl_miso_ws(&self) -> bool {
        *self == FUNC_A::FC6_TXD_SCL_MISO_WS
    }
    #[doc = "Checks if the value of the field is `SEC_PIO0_12`"]
    #[inline(always)]
    pub fn is_sec_pio0_12(&self) -> bool {
        *self == FUNC_A::SEC_PIO0_12
    }
}
#[doc = "Field `FUNC` writer - Selects pin function."]
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO0_12_SPEC, u8, FUNC_A, 4, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    #[doc = "General-purpose digital input/output pin. ADC input channel 10 in analog mode."]
    #[inline(always)]
    pub fn pio0_12_adc0_10(self) -> &'a mut W {
        self.variant(FUNC_A::PIO0_12_ADC0_10)
    }
    #[doc = "Flexcomm 3 USART transmitter, I2C clock, SPI master-in/slave-out data I/O, I2S word-select/frame."]
    #[inline(always)]
    pub fn fc3_txd_scl_miso_ws(self) -> &'a mut W {
        self.variant(FUNC_A::FC3_TXD_SCL_MISO_WS)
    }
    #[doc = "Frequency Measure pin clock input B."]
    #[inline(always)]
    pub fn freqme_gpio_clk_b(self) -> &'a mut W {
        self.variant(FUNC_A::FREQME_GPIO_CLK_B)
    }
    #[doc = "Pin input 7 to SCTimer/PWM."]
    #[inline(always)]
    pub fn sct0_gpi7(self) -> &'a mut W {
        self.variant(FUNC_A::SCT0_GPI7)
    }
    #[doc = "Serial Debug Wire I/O."]
    #[inline(always)]
    pub fn swdio(self) -> &'a mut W {
        self.variant(FUNC_A::SWDIO)
    }
    #[doc = "Flexcomm 6 USART transmitter, I2C clock, SPI master-in/slave-out data I/O, I2S word-select/frame."]
    #[inline(always)]
    pub fn fc6_txd_scl_miso_ws(self) -> &'a mut W {
        self.variant(FUNC_A::FC6_TXD_SCL_MISO_WS)
    }
    #[doc = "Secure GPIO pin."]
    #[inline(always)]
    pub fn sec_pio0_12(self) -> &'a mut W {
        self.variant(FUNC_A::SEC_PIO0_12)
    }
}
...
pub type SLEW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_12_SPEC, SLEW_A, O>;
...
pub type INVERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_12_SPEC, INVERT_A, O>;
...
pub type DIGIMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_12_SPEC, DIGIMODE_A, O>;
...
pub type ASW_R = crate::BitReader<ASW_A>;
...
pub type ASW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_12_SPEC, ASW_A, O>;
impl<'a, const O: u8> ASW_W<'a, O> {
