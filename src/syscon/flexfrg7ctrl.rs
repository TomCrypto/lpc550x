...
pub type DIV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FLEXFRG7CTRL_SPEC, u8, u8, 8, O>;
...
pub type MULT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FLEXFRG7CTRL_SPEC, u8, u8, 8, O>;
impl R {
