...
pub type SWR_RESET_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SWR_RESET_SPEC, u32, SWR_RESET_AW, 32, O>;
impl<'a, const O: u8> SWR_RESET_W<'a, O> {
...
impl W {
    ...
    #[inline(always)]
    pub fn swr_reset(&mut self) -> SWR_RESET_W<0> {
        SWR_RESET_W::new(self)
    }
