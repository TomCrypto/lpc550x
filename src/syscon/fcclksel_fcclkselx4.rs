...
impl From<crate::R<FCCLKSEL_FCCLKSELX4_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<FCCLKSEL_FCCLKSELX4_SPEC>> for W {
    #[inline(always)]
...
pub type DATA_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FCCLKSEL_FCCLKSELX4_SPEC, u32, u32, 32, O>;
impl R {
