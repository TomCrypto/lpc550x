...
pub type MRT_RST_W<'a, const O: u8> = crate::BitWriter<'a, u32, PRESETCTRL1_SPEC, MRT_RST_A, O>;
...
pub type OSTIMER_RST_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PRESETCTRL1_SPEC, OSTIMER_RST_A, O>;
...
pub type SCT_RST_W<'a, const O: u8> = crate::BitWriter<'a, u32, PRESETCTRL1_SPEC, SCT_RST_A, O>;
...
impl From<CAN_RST_A> for bool {
    #[inline(always)]
    fn from(variant: CAN_RST_A) -> Self {
        variant as u8 != 0
    }
}
impl CAN_RST_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> CAN_RST_A {
        match self.bits {
            false => CAN_RST_A::RELEASED,
            true => CAN_RST_A::ASSERTED,
        }
    }
    #[doc = "Checks if the value of the field is `RELEASED`"]
    #[inline(always)]
    pub fn is_released(&self) -> bool {
        *self == CAN_RST_A::RELEASED
    }
    #[doc = "Checks if the value of the field is `ASSERTED`"]
    #[inline(always)]
    pub fn is_asserted(&self) -> bool {
        *self == CAN_RST_A::ASSERTED
    }
}
#[doc = "Field `CAN_RST` writer - CAN reset control."]
pub type CAN_RST_W<'a, const O: u8> = crate::BitWriter<'a, u32, PRESETCTRL1_SPEC, CAN_RST_A, O>;
impl<'a, const O: u8> CAN_RST_W<'a, O> {
    #[doc = "Bloc is not reset."]
    #[inline(always)]
    pub fn released(self) -> &'a mut W {
        self.variant(CAN_RST_A::RELEASED)
    }
    #[doc = "Bloc is reset."]
    #[inline(always)]
    pub fn asserted(self) -> &'a mut W {
        self.variant(CAN_RST_A::ASSERTED)
    }
}
...
pub type UTICK_RST_W<'a, const O: u8> = crate::BitWriter<'a, u32, PRESETCTRL1_SPEC, UTICK_RST_A, O>;
...
pub type FC0_RST_W<'a, const O: u8> = crate::BitWriter<'a, u32, PRESETCTRL1_SPEC, FC0_RST_A, O>;
...
pub type FC1_RST_W<'a, const O: u8> = crate::BitWriter<'a, u32, PRESETCTRL1_SPEC, FC1_RST_A, O>;
...
pub type FC2_RST_W<'a, const O: u8> = crate::BitWriter<'a, u32, PRESETCTRL1_SPEC, FC2_RST_A, O>;
...
pub type FC3_RST_W<'a, const O: u8> = crate::BitWriter<'a, u32, PRESETCTRL1_SPEC, FC3_RST_A, O>;
...
pub type FC4_RST_W<'a, const O: u8> = crate::BitWriter<'a, u32, PRESETCTRL1_SPEC, FC4_RST_A, O>;
...
pub type FC5_RST_W<'a, const O: u8> = crate::BitWriter<'a, u32, PRESETCTRL1_SPEC, FC5_RST_A, O>;
...
pub type FC6_RST_W<'a, const O: u8> = crate::BitWriter<'a, u32, PRESETCTRL1_SPEC, FC6_RST_A, O>;
...
pub type FC7_RST_W<'a, const O: u8> = crate::BitWriter<'a, u32, PRESETCTRL1_SPEC, FC7_RST_A, O>;
...
pub type TIMER2_RST_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PRESETCTRL1_SPEC, TIMER2_RST_A, O>;
...
pub type TIMER0_RST_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PRESETCTRL1_SPEC, TIMER0_RST_A, O>;
...
pub type TIMER1_RST_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PRESETCTRL1_SPEC, TIMER1_RST_A, O>;
...
impl W {
    ...
    #[doc = "Bit 7 - CAN reset control."]
    #[inline(always)]
    pub fn can_rst(&mut self) -> CAN_RST_W<7> {
        CAN_RST_W::new(self)
    }
    #[doc = "Bit 10 - UTICK reset control."]
    #[inline(always)]
