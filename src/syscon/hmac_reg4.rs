...
pub struct R(crate::R<HMAC_REG4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HMAC_REG4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HMAC_REG4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HMAC_REG4_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HMAC_REG4` writer"]
pub struct W(crate::W<HMAC_REG4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HMAC_REG4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HMAC_REG4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HMAC_REG4_SPEC>) -> Self {
        W(writer)
    }
}
...
impl crate::Readable for HMAC_REG4_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [hmac_reg4::W](W) writer structure"]
impl crate::Writable for HMAC_REG4_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets HMAC_REG4 to value 0"]
impl crate::Resettable for HMAC_REG4_SPEC {
    #[inline(always)]
