...
pub struct R(crate::R<CANCLKDIV_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CANCLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CANCLKDIV_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CANCLKDIV_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CANCLKDIV` writer"]
pub struct W(crate::W<CANCLKDIV_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CANCLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CANCLKDIV_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CANCLKDIV_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DIV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CANCLKDIV_SPEC, u8, u8, 8, O>;
...
pub type RESET_W<'a, const O: u8> = crate::BitWriter<'a, u32, CANCLKDIV_SPEC, RESET_AW, O>;
...
pub type HALT_W<'a, const O: u8> = crate::BitWriter<'a, u32, CANCLKDIV_SPEC, HALT_A, O>;
...
impl crate::Readable for CANCLKDIV_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [canclkdiv::W](W) writer structure"]
impl crate::Writable for CANCLKDIV_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CANCLKDIV to value 0x4000_0000"]
impl crate::Resettable for CANCLKDIV_SPEC {
    #[inline(always)]
