...
impl From<crate::R<FCCLKSEL_FCCLKSEL3_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<FCCLKSEL_FCCLKSEL3_SPEC>> for W {
    #[inline(always)]
...
pub type SEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, FCCLKSEL_FCCLKSEL3_SPEC, u8, SEL_A, 3, O>;
