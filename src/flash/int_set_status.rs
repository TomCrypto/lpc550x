...
pub type FAIL_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_SET_STATUS_SPEC, bool, O>;
#[doc = "Field `ERR` writer - When a SET_STATUS bit is written to 1, the corresponding INT_STATUS bit is set."]
pub type ERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_SET_STATUS_SPEC, bool, O>;
#[doc = "Field `DONE` writer - When a SET_STATUS bit is written to 1, the corresponding INT_STATUS bit is set."]
pub type DONE_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_SET_STATUS_SPEC, bool, O>;
#[doc = "Field `ECC_ERR` writer - When a SET_STATUS bit is written to 1, the corresponding INT_STATUS bit is set."]
pub type ECC_ERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_SET_STATUS_SPEC, bool, O>;
impl W {
