...
pub struct RegisterBlock {
    ...
    #[doc = "0x2000..0x2008 - Direction registers for all port GPIO pins. Supported pins depends on the specific device and package."]
    pub dir: [DIR; 2],
    _reserved3: [u8; 0x78],
    ...
    pub mpin: [MPIN; 2],
    _reserved6: [u8; 0x78],
    #[doc = "0x2200..0x2208 - Set register for port."]
    pub set: [SET; 2],
    _reserved7: [u8; 0x78],
    #[doc = "0x2280..0x2288 - Clear register for port."]
    pub clr: [CLR; 2],
    _reserved8: [u8; 0x78],
