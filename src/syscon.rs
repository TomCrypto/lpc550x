...
pub struct RegisterBlock {
    ...
    _reserved44: [u8; 0x10],
    _reserved_44_flexfrgctrl: [u8; 0x04],
    _reserved_45_flexfrgctrl: [u8; 0x04],
...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub fn presetctrl_presetctrlx0(&self) -> &PRESETCTRL_PRESETCTRLX0 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(256usize) as *const PRESETCTRL_PRESETCTRLX0)
        }
    }
    #[doc = "0x100 - Peripheral reset control 0"]
    #[inline(always)]
    pub fn presetctrl_presetctrl0(&self) -> &PRESETCTRL_PRESETCTRL0 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(256usize) as *const PRESETCTRL_PRESETCTRL0)
        }
    }
    #[doc = "0x104 - Peripheral reset control register"]
    #[inline(always)]
    pub fn presetctrl_presetctrlx1(&self) -> &PRESETCTRL_PRESETCTRLX1 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(260usize) as *const PRESETCTRL_PRESETCTRLX1)
        }
    }
    #[doc = "0x104 - Peripheral reset control 1"]
    #[inline(always)]
    pub fn presetctrl_presetctrl1(&self) -> &PRESETCTRL_PRESETCTRL1 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(260usize) as *const PRESETCTRL_PRESETCTRL1)
        }
    }
    #[doc = "0x108 - Peripheral reset control register"]
    #[inline(always)]
    pub fn presetctrl_presetctrlx2(&self) -> &PRESETCTRL_PRESETCTRLX2 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(264usize) as *const PRESETCTRL_PRESETCTRLX2)
        }
    }
    #[doc = "0x108 - Peripheral reset control 2"]
    #[inline(always)]
    pub fn presetctrl_presetctrl2(&self) -> &PRESETCTRL_PRESETCTRL2 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(264usize) as *const PRESETCTRL_PRESETCTRL2)
        }
    }
    #[doc = "0x200 - Peripheral reset control register"]
    #[inline(always)]
    pub fn ahbclkctrl_ahbclkctrlx0(&self) -> &AHBCLKCTRL_AHBCLKCTRLX0 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(512usize) as *const AHBCLKCTRL_AHBCLKCTRLX0)
        }
    }
    #[doc = "0x200 - AHB Clock control 0"]
    #[inline(always)]
    pub fn ahbclkctrl_ahbclkctrl0(&self) -> &AHBCLKCTRL_AHBCLKCTRL0 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(512usize) as *const AHBCLKCTRL_AHBCLKCTRL0)
        }
    }
    #[doc = "0x204 - Peripheral reset control register"]
    #[inline(always)]
    pub fn ahbclkctrl_ahbclkctrlx1(&self) -> &AHBCLKCTRL_AHBCLKCTRLX1 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(516usize) as *const AHBCLKCTRL_AHBCLKCTRLX1)
        }
    }
    #[doc = "0x204 - AHB Clock control 1"]
    #[inline(always)]
    pub fn ahbclkctrl_ahbclkctrl1(&self) -> &AHBCLKCTRL_AHBCLKCTRL1 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(516usize) as *const AHBCLKCTRL_AHBCLKCTRL1)
        }
    }
    #[doc = "0x208 - Peripheral reset control register"]
    #[inline(always)]
    pub fn ahbclkctrl_ahbclkctrlx2(&self) -> &AHBCLKCTRL_AHBCLKCTRLX2 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(520usize) as *const AHBCLKCTRL_AHBCLKCTRLX2)
        }
    }
    #[doc = "0x208 - AHB Clock control 2"]
    #[inline(always)]
    pub fn ahbclkctrl_ahbclkctrl2(&self) -> &AHBCLKCTRL_AHBCLKCTRL2 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(520usize) as *const AHBCLKCTRL_AHBCLKCTRL2)
        }
    }
    #[doc = "0x260 - Peripheral reset control register"]
    #[inline(always)]
    pub fn systickclksel_systickclkselx0(&self) -> &SYSTICKCLKSEL_SYSTICKCLKSELX0 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(608usize)
                as *const SYSTICKCLKSEL_SYSTICKCLKSELX0)
        }
    }
    #[doc = "0x260 - System Tick Timer for CPU0 source select"]
    #[inline(always)]
    pub fn systickclksel_systickclksel0(&self) -> &SYSTICKCLKSEL_SYSTICKCLKSEL0 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(608usize)
                as *const SYSTICKCLKSEL_SYSTICKCLKSEL0)
        }
    }
    #[doc = "0x26c - Peripheral reset control register"]
    #[inline(always)]
    pub fn ctimerclksel_ctimerclkselx0(&self) -> &CTIMERCLKSEL_CTIMERCLKSELX0 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(620usize)
                as *const CTIMERCLKSEL_CTIMERCLKSELX0)
        }
    }
    #[doc = "0x26c - CTimer 0 clock source select"]
    #[inline(always)]
    pub fn ctimerclksel_ctimerclksel0(&self) -> &CTIMERCLKSEL_CTIMERCLKSEL0 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(620usize)
                as *const CTIMERCLKSEL_CTIMERCLKSEL0)
        }
    }
    #[doc = "0x270 - Peripheral reset control register"]
    #[inline(always)]
    pub fn ctimerclksel_ctimerclkselx1(&self) -> &CTIMERCLKSEL_CTIMERCLKSELX1 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(624usize)
                as *const CTIMERCLKSEL_CTIMERCLKSELX1)
        }
    }
    #[doc = "0x270 - CTimer 1 clock source select"]
    #[inline(always)]
    pub fn ctimerclksel_ctimerclksel1(&self) -> &CTIMERCLKSEL_CTIMERCLKSEL1 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(624usize)
                as *const CTIMERCLKSEL_CTIMERCLKSEL1)
        }
    }
    #[doc = "0x274 - Peripheral reset control register"]
    #[inline(always)]
    pub fn ctimerclksel_ctimerclkselx2(&self) -> &CTIMERCLKSEL_CTIMERCLKSELX2 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(628usize)
                as *const CTIMERCLKSEL_CTIMERCLKSELX2)
        }
    }
    #[doc = "0x274 - CTimer 2 clock source select"]
    #[inline(always)]
    pub fn ctimerclksel_ctimerclksel2(&self) -> &CTIMERCLKSEL_CTIMERCLKSEL2 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(628usize)
                as *const CTIMERCLKSEL_CTIMERCLKSEL2)
        }
    }
    #[doc = "0x278 - Peripheral reset control register"]
    #[inline(always)]
    pub fn ctimerclksel_ctimerclkselx3(&self) -> &CTIMERCLKSEL_CTIMERCLKSELX3 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(632usize)
                as *const CTIMERCLKSEL_CTIMERCLKSELX3)
        }
    }
    #[doc = "0x278 - CTimer 3 clock source select"]
    #[inline(always)]
    pub fn ctimerclksel_ctimerclksel3(&self) -> &CTIMERCLKSEL_CTIMERCLKSEL3 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(632usize)
                as *const CTIMERCLKSEL_CTIMERCLKSEL3)
        }
    }
    #[doc = "0x27c - Peripheral reset control register"]
    #[inline(always)]
    pub fn ctimerclksel_ctimerclkselx4(&self) -> &CTIMERCLKSEL_CTIMERCLKSELX4 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(636usize)
                as *const CTIMERCLKSEL_CTIMERCLKSELX4)
        }
    }
    #[doc = "0x27c - CTimer 4 clock source select"]
    #[inline(always)]
    pub fn ctimerclksel_ctimerclksel4(&self) -> &CTIMERCLKSEL_CTIMERCLKSEL4 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(636usize)
                as *const CTIMERCLKSEL_CTIMERCLKSEL4)
        }
    }
    #[doc = "0x2b0 - Peripheral reset control register"]
    #[inline(always)]
    pub fn fcclksel_fcclkselx0(&self) -> &FCCLKSEL_FCCLKSELX0 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(688usize) as *const FCCLKSEL_FCCLKSELX0)
        }
    }
    #[doc = "0x2b0 - Flexcomm Interface 0 clock source select for Fractional Rate Divider"]
    #[inline(always)]
    pub fn fcclksel_fcclksel0(&self) -> &FCCLKSEL_FCCLKSEL0 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(688usize) as *const FCCLKSEL_FCCLKSEL0)
        }
    }
    #[doc = "0x2b4 - Peripheral reset control register"]
    #[inline(always)]
    pub fn fcclksel_fcclkselx1(&self) -> &FCCLKSEL_FCCLKSELX1 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(692usize) as *const FCCLKSEL_FCCLKSELX1)
        }
    }
    #[doc = "0x2b4 - Flexcomm Interface 1 clock source select for Fractional Rate Divider"]
    #[inline(always)]
    pub fn fcclksel_fcclksel1(&self) -> &FCCLKSEL_FCCLKSEL1 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(692usize) as *const FCCLKSEL_FCCLKSEL1)
        }
    }
    #[doc = "0x2b8 - Peripheral reset control register"]
    #[inline(always)]
    pub fn fcclksel_fcclkselx2(&self) -> &FCCLKSEL_FCCLKSELX2 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(696usize) as *const FCCLKSEL_FCCLKSELX2)
        }
    }
    #[doc = "0x2b8 - Flexcomm Interface 2 clock source select for Fractional Rate Divider"]
    #[inline(always)]
    pub fn fcclksel_fcclksel2(&self) -> &FCCLKSEL_FCCLKSEL2 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(696usize) as *const FCCLKSEL_FCCLKSEL2)
        }
    }
    #[doc = "0x2bc - Peripheral reset control register"]
    #[inline(always)]
    pub fn fcclksel_fcclkselx3(&self) -> &FCCLKSEL_FCCLKSELX3 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(700usize) as *const FCCLKSEL_FCCLKSELX3)
        }
    }
    #[doc = "0x2bc - Flexcomm Interface 3 clock source select for Fractional Rate Divider"]
    #[inline(always)]
    pub fn fcclksel_fcclksel3(&self) -> &FCCLKSEL_FCCLKSEL3 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(700usize) as *const FCCLKSEL_FCCLKSEL3)
        }
    }
    #[doc = "0x2c0 - Peripheral reset control register"]
    #[inline(always)]
    pub fn fcclksel_fcclkselx4(&self) -> &FCCLKSEL_FCCLKSELX4 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(704usize) as *const FCCLKSEL_FCCLKSELX4)
        }
    }
    #[doc = "0x2c0 - Flexcomm Interface 4 clock source select for Fractional Rate Divider"]
    #[inline(always)]
    pub fn fcclksel_fcclksel4(&self) -> &FCCLKSEL_FCCLKSEL4 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(704usize) as *const FCCLKSEL_FCCLKSEL4)
        }
    }
    #[doc = "0x2c4 - Peripheral reset control register"]
    #[inline(always)]
    pub fn fcclksel_fcclkselx5(&self) -> &FCCLKSEL_FCCLKSELX5 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(708usize) as *const FCCLKSEL_FCCLKSELX5)
        }
    }
    #[doc = "0x2c4 - Flexcomm Interface 5 clock source select for Fractional Rate Divider"]
    #[inline(always)]
    pub fn fcclksel_fcclksel5(&self) -> &FCCLKSEL_FCCLKSEL5 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(708usize) as *const FCCLKSEL_FCCLKSEL5)
        }
    }
    #[doc = "0x2c8 - Peripheral reset control register"]
    #[inline(always)]
    pub fn fcclksel_fcclkselx6(&self) -> &FCCLKSEL_FCCLKSELX6 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(712usize) as *const FCCLKSEL_FCCLKSELX6)
        }
    }
    #[doc = "0x2c8 - Flexcomm Interface 6 clock source select for Fractional Rate Divider"]
    #[inline(always)]
    pub fn fcclksel_fcclksel6(&self) -> &FCCLKSEL_FCCLKSEL6 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(712usize) as *const FCCLKSEL_FCCLKSEL6)
        }
    }
    #[doc = "0x2cc - Peripheral reset control register"]
    #[inline(always)]
    pub fn fcclksel_fcclkselx7(&self) -> &FCCLKSEL_FCCLKSELX7 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(716usize) as *const FCCLKSEL_FCCLKSELX7)
        }
    }
    #[doc = "0x2cc - Flexcomm Interface 7 clock source select for Fractional Rate Divider"]
    #[inline(always)]
    pub fn fcclksel_fcclksel7(&self) -> &FCCLKSEL_FCCLKSEL7 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(716usize) as *const FCCLKSEL_FCCLKSEL7)
        }
    }
    #[doc = "0x320 - Peripheral reset control register"]
    #[inline(always)]
    pub fn flexfrgctrl_flexfrgxctrl0(&self) -> &FLEXFRGCTRL_FLEXFRGXCTRL0 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(800usize)
                as *const FLEXFRGCTRL_FLEXFRGXCTRL0)
        }
    }
    #[doc = "0x320 - Fractional rate divider for flexcomm 0"]
    #[inline(always)]
    pub fn flexfrgctrl_flexfrg0ctrl(&self) -> &FLEXFRGCTRL_FLEXFRG0CTRL {
        unsafe {
            &*(((self as *const Self) as *const u8).add(800usize)
                as *const FLEXFRGCTRL_FLEXFRG0CTRL)
        }
    }
    #[doc = "0x324 - Peripheral reset control register"]
    #[inline(always)]
    pub fn flexfrgctrl_flexfrgxctrl1(&self) -> &FLEXFRGCTRL_FLEXFRGXCTRL1 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(804usize)
                as *const FLEXFRGCTRL_FLEXFRGXCTRL1)
        }
    }
    #[doc = "0x324 - Fractional rate divider for flexcomm 1"]
    #[inline(always)]
    pub fn flexfrgctrl_flexfrg1ctrl(&self) -> &FLEXFRGCTRL_FLEXFRG1CTRL {
        unsafe {
            &*(((self as *const Self) as *const u8).add(804usize)
                as *const FLEXFRGCTRL_FLEXFRG1CTRL)
        }
    }
    #[doc = "0x328 - Peripheral reset control register"]
    #[inline(always)]
    pub fn flexfrgctrl_flexfrgxctrl2(&self) -> &FLEXFRGCTRL_FLEXFRGXCTRL2 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(808usize)
                as *const FLEXFRGCTRL_FLEXFRGXCTRL2)
        }
    }
    #[doc = "0x328 - Fractional rate divider for flexcomm 2"]
    #[inline(always)]
    pub fn flexfrgctrl_flexfrg2ctrl(&self) -> &FLEXFRGCTRL_FLEXFRG2CTRL {
        unsafe {
            &*(((self as *const Self) as *const u8).add(808usize)
                as *const FLEXFRGCTRL_FLEXFRG2CTRL)
        }
    }
    #[doc = "0x32c - Peripheral reset control register"]
    #[inline(always)]
    pub fn flexfrgctrl_flexfrgxctrl3(&self) -> &FLEXFRGCTRL_FLEXFRGXCTRL3 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(812usize)
                as *const FLEXFRGCTRL_FLEXFRGXCTRL3)
        }
    }
    #[doc = "0x32c - Fractional rate divider for flexcomm 3"]
    #[inline(always)]
    pub fn flexfrgctrl_flexfrg3ctrl(&self) -> &FLEXFRGCTRL_FLEXFRG3CTRL {
        unsafe {
            &*(((self as *const Self) as *const u8).add(812usize)
                as *const FLEXFRGCTRL_FLEXFRG3CTRL)
        }
    }
    #[doc = "0x330 - Peripheral reset control register"]
    #[inline(always)]
    pub fn flexfrgctrl_flexfrgxctrl4(&self) -> &FLEXFRGCTRL_FLEXFRGXCTRL4 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(816usize)
                as *const FLEXFRGCTRL_FLEXFRGXCTRL4)
        }
    }
    #[doc = "0x330 - Fractional rate divider for flexcomm 4"]
    #[inline(always)]
    pub fn flexfrgctrl_flexfrg4ctrl(&self) -> &FLEXFRGCTRL_FLEXFRG4CTRL {
        unsafe {
            &*(((self as *const Self) as *const u8).add(816usize)
                as *const FLEXFRGCTRL_FLEXFRG4CTRL)
        }
    }
    #[doc = "0x334 - Peripheral reset control register"]
    #[inline(always)]
    pub fn flexfrgctrl_flexfrgxctrl5(&self) -> &FLEXFRGCTRL_FLEXFRGXCTRL5 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(820usize)
                as *const FLEXFRGCTRL_FLEXFRGXCTRL5)
        }
    }
    #[doc = "0x334 - Fractional rate divider for flexcomm 5"]
    #[inline(always)]
    pub fn flexfrgctrl_flexfrg5ctrl(&self) -> &FLEXFRGCTRL_FLEXFRG5CTRL {
        unsafe {
            &*(((self as *const Self) as *const u8).add(820usize)
                as *const FLEXFRGCTRL_FLEXFRG5CTRL)
        }
    }
    #[doc = "0x338 - Peripheral reset control register"]
    #[inline(always)]
    pub fn flexfrgctrl_flexfrgxctrl6(&self) -> &FLEXFRGCTRL_FLEXFRGXCTRL6 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(824usize)
                as *const FLEXFRGCTRL_FLEXFRGXCTRL6)
        }
    }
    #[doc = "0x338 - Fractional rate divider for flexcomm 6"]
    #[inline(always)]
    pub fn flexfrgctrl_flexfrg6ctrl(&self) -> &FLEXFRGCTRL_FLEXFRG6CTRL {
        unsafe {
            &*(((self as *const Self) as *const u8).add(824usize)
                as *const FLEXFRGCTRL_FLEXFRG6CTRL)
        }
    }
    #[doc = "0x33c - Peripheral reset control register"]
    #[inline(always)]
    pub fn flexfrgctrl_flexfrgxctrl7(&self) -> &FLEXFRGCTRL_FLEXFRGXCTRL7 {
        unsafe {
            &*(((self as *const Self) as *const u8).add(828usize)
                as *const FLEXFRGCTRL_FLEXFRGXCTRL7)
        }
    }
    #[doc = "0x33c - Fractional rate divider for flexcomm 7"]
    #[inline(always)]
    pub fn flexfrgctrl_flexfrg7ctrl(&self) -> &FLEXFRGCTRL_FLEXFRG7CTRL {
        unsafe {
            &*(((self as *const Self) as *const u8).add(828usize)
                as *const FLEXFRGCTRL_FLEXFRG7CTRL)
        }
    }
}
