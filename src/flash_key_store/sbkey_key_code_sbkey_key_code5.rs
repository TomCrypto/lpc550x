...
impl From<crate::R<SBKEY_KEY_CODE_SBKEY_KEY_CODE5_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<SBKEY_KEY_CODE_SBKEY_KEY_CODE5_SPEC>> for W {
    #[inline(always)]
...
pub type FIELD_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SBKEY_KEY_CODE_SBKEY_KEY_CODE5_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - ."]
    #[inline(always)]
