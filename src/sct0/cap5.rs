...
pub type CAPN_L_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CAP5_SPEC, u16, u16, 16, O>;
...
pub type CAPN_H_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CAP5_SPEC, u16, u16, 16, O>;
impl R {
