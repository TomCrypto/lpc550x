...
pub type MATCHN_L_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MATCH1_SPEC, u16, u16, 16, O>;
...
pub type MATCHN_H_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MATCH1_SPEC, u16, u16, 16, O>;
impl R {
