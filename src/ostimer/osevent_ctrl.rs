...
pub type OSTIMER_INTRFLAG_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, OSEVENT_CTRL_SPEC, bool, O>;
...
pub type OSTIMER_INTENA_R = crate::BitReader<bool>;
...
pub type OSTIMER_INTENA_W<'a, const O: u8> = crate::BitWriter<'a, u32, OSEVENT_CTRL_SPEC, bool, O>;
