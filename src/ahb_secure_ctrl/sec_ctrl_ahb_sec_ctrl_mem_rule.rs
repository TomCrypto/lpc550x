...
pub type AHB_SEC_CTRL_SECT_0_RULE_W<'a, const O: u8> = crate::FieldWriterSafe<
    'a,
    u32,
    SEC_CTRL_AHB_SEC_CTRL_MEM_RULE_SPEC,
    u8,
    AHB_SEC_CTRL_SECT_0_RULE_A,
    2,
    O,
>;
impl<'a, const O: u8> AHB_SEC_CTRL_SECT_0_RULE_W<'a, O> {
...
pub type AHB_SEC_CTRL_SECT_1_RULE_W<'a, const O: u8> = crate::FieldWriterSafe<
    ...
    SEC_CTRL_AHB_SEC_CTRL_MEM_RULE_SPEC,
    u8,
    AHB_SEC_CTRL_SECT_1_RULE_A,
    2,
    O,
>;
impl<'a, const O: u8> AHB_SEC_CTRL_SECT_1_RULE_W<'a, O> {
    #[doc = "Non-secure and Non-priviledge user access allowed."]
    #[inline(always)]
    pub fn enum_ns_np(self) -> &'a mut W {
...
pub type AHB_SEC_CTRL_SECT_2_RULE_W<'a, const O: u8> = crate::FieldWriterSafe<
    ...
    SEC_CTRL_AHB_SEC_CTRL_MEM_RULE_SPEC,
    u8,
    AHB_SEC_CTRL_SECT_2_RULE_A,
    2,
    O,
>;
impl<'a, const O: u8> AHB_SEC_CTRL_SECT_2_RULE_W<'a, O> {
    #[doc = "Non-secure and Non-priviledge user access allowed."]
    #[inline(always)]
    pub fn enum_ns_np(self) -> &'a mut W {
...
pub type AHB_SEC_CTRL_SECT_3_RULE_W<'a, const O: u8> = crate::FieldWriterSafe<
    ...
    SEC_CTRL_AHB_SEC_CTRL_MEM_RULE_SPEC,
    u8,
    AHB_SEC_CTRL_SECT_3_RULE_A,
    2,
    O,
>;
impl<'a, const O: u8> AHB_SEC_CTRL_SECT_3_RULE_W<'a, O> {
    #[doc = "Non-secure and Non-priviledge user access allowed."]
    #[inline(always)]
    pub fn enum_ns_np(self) -> &'a mut W {
