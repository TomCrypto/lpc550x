...
pub type NIDEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CC_SOCU_DFLT_SPEC, NIDEN_A, O>;
...
pub type DBGEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CC_SOCU_DFLT_SPEC, DBGEN_A, O>;
...
pub type SPNIDEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CC_SOCU_DFLT_SPEC, SPNIDEN_A, O>;
...
pub type SPIDEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CC_SOCU_DFLT_SPEC, SPIDEN_A, O>;
...
pub type TAPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CC_SOCU_DFLT_SPEC, TAPEN_A, O>;
...
pub type ISP_CMD_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CC_SOCU_DFLT_SPEC, ISP_CMD_EN_A, O>;
...
impl FA_ME_CMD_EN_R {
    ...
    pub fn variant(&self) -> FA_ME_CMD_EN_A {
        match self.bits {
            false => FA_ME_CMD_EN_A::DISABLE,
            true => FA_ME_CMD_EN_A::ENABLE,
        }
    }
    #[doc = "Checks if the value of the field is `DISABLE`"]
    #[inline(always)]
...
pub type FA_ME_CMD_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CC_SOCU_DFLT_SPEC, FA_ME_CMD_EN_A, O>;
...
pub type INVERSE_VALUE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CC_SOCU_DFLT_SPEC, u16, u16, 16, O>;
impl R {
