...
pub mod sct0_inmux;
#[doc = "TIMER0CAPTSEL (rw) register accessor: an alias for `Reg<TIMER0CAPTSEL_SPEC>`"]
...
#[doc = "TIMER1CAPTSEL (rw) register accessor: an alias for `Reg<TIMER1CAPTSEL_SPEC>`"]
...
#[doc = "TIMER2CAPTSEL (rw) register accessor: an alias for `Reg<TIMER2CAPTSEL_SPEC>`"]
...
pub mod pintsel;
#[doc = "DMA0_ITRIG_INMUX (rw) register accessor: an alias for `Reg<DMA0_ITRIG_INMUX_SPEC>`"]
...
#[doc = "DMA0_OTRIG_INMUX (rw) register accessor: an alias for `Reg<DMA0_OTRIG_INMUX_SPEC>`"]
...
#[doc = "TIMER3CAPTSEL (rw) register accessor: an alias for `Reg<TIMER3CAPTSEL_SPEC>`"]
...
#[doc = "TIMER4CAPTSEL (rw) register accessor: an alias for `Reg<TIMER4CAPTSEL_SPEC>`"]
...
#[doc = "PINTSECSEL (rw) register accessor: an alias for `Reg<PINTSECSEL_SPEC>`"]
pub type PINTSECSEL = crate::Reg<pintsecsel::PINTSECSEL_SPEC>;
#[doc = "Pin interrupt secure select register."]
pub mod pintsecsel;
#[doc = "DMA1_ITRIG_INMUX (rw) register accessor: an alias for `Reg<DMA1_ITRIG_INMUX_SPEC>`"]
...
#[doc = "DMA1_OTRIG_INMUX (rw) register accessor: an alias for `Reg<DMA1_OTRIG_INMUX_SPEC>`"]
...
#[doc = "DMA0_REQ_ENA (rw) register accessor: an alias for `Reg<DMA0_REQ_ENA_SPEC>`"]
pub type DMA0_REQ_ENA = crate::Reg<dma0_req_ena::DMA0_REQ_ENA_SPEC>;
#[doc = "Enable DMA0 requests."]
pub mod dma0_req_ena;
#[doc = "DMA0_REQ_ENA_SET (w) register accessor: an alias for `Reg<DMA0_REQ_ENA_SET_SPEC>`"]
...
#[doc = "DMA0_REQ_ENA_CLR (w) register accessor: an alias for `Reg<DMA0_REQ_ENA_CLR_SPEC>`"]
...
#[doc = "DMA1_REQ_ENA (rw) register accessor: an alias for `Reg<DMA1_REQ_ENA_SPEC>`"]
pub type DMA1_REQ_ENA = crate::Reg<dma1_req_ena::DMA1_REQ_ENA_SPEC>;
#[doc = "Enable DMA1 requests."]
pub mod dma1_req_ena;
#[doc = "DMA1_REQ_ENA_SET (w) register accessor: an alias for `Reg<DMA1_REQ_ENA_SET_SPEC>`"]
...
#[doc = "DMA1_REQ_ENA_CLR (w) register accessor: an alias for `Reg<DMA1_REQ_ENA_CLR_SPEC>`"]
...
#[doc = "DMA0_ITRIG_ENA (rw) register accessor: an alias for `Reg<DMA0_ITRIG_ENA_SPEC>`"]
pub type DMA0_ITRIG_ENA = crate::Reg<dma0_itrig_ena::DMA0_ITRIG_ENA_SPEC>;
#[doc = "Enable DMA0 triggers."]
pub mod dma0_itrig_ena;
#[doc = "DMA0_ITRIG_ENA_SET (w) register accessor: an alias for `Reg<DMA0_ITRIG_ENA_SET_SPEC>`"]
...
#[doc = "DMA0_ITRIG_ENA_CLR (w) register accessor: an alias for `Reg<DMA0_ITRIG_ENA_CLR_SPEC>`"]
...
#[doc = "DMA1_ITRIG_ENA (rw) register accessor: an alias for `Reg<DMA1_ITRIG_ENA_SPEC>`"]
pub type DMA1_ITRIG_ENA = crate::Reg<dma1_itrig_ena::DMA1_ITRIG_ENA_SPEC>;
#[doc = "Enable DMA1 triggers."]
pub mod dma1_itrig_ena;
#[doc = "DMA1_ITRIG_ENA_SET (w) register accessor: an alias for `Reg<DMA1_ITRIG_ENA_SET_SPEC>`"]
...
#[doc = "DMA1_ITRIG_ENA_CLR (w) register accessor: an alias for `Reg<DMA1_ITRIG_ENA_CLR_SPEC>`"]
