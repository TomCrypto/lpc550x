...
pub type OUTPUTN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OUTPUT_MUX_SPEC, u8, OUTPUTN_A, 5, O>;
impl<'a, const O: u8> OUTPUTN_W<'a, O> {
...
impl W {
    #[doc = "Bits 0:4 - Selects the source to be connected to PLU Output 0."]
    #[inline(always)]
    pub fn outputn(&mut self) -> OUTPUTN_W<0> {
        OUTPUTN_W::new(self)
    }
