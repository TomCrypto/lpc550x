...
pub type SADISABLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, SLVADR3_SPEC, SADISABLE_A, O>;
...
pub type SLVADR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SLVADR3_SPEC, u8, u8, 7, O>;
impl R {
