...
pub struct R(crate::R<GPO0_GPO0_2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPO0_GPO0_2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPO0_GPO0_2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPO0_GPO0_2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPO0_2` writer"]
pub struct W(crate::W<GPO0_GPO0_2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPO0_GPO0_2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPO0_GPO0_2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPO0_GPO0_2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SYSTEM_SPEED_CODE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GPO0_GPO0_2_SPEC, u8, u8, 2, O>;
...
pub type FIELD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GPO0_GPO0_2_SPEC, u32, u32, 28, O>;
impl R {
...
#[doc = "GPO0 register 2 description\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpo0_gpo0_2](index.html) module"]
pub struct GPO0_GPO0_2_SPEC;
impl crate::RegisterSpec for GPO0_GPO0_2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpo0_gpo0_2::R](R) reader structure"]
impl crate::Readable for GPO0_GPO0_2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpo0_gpo0_2::W](W) writer structure"]
impl crate::Writable for GPO0_GPO0_2_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets GPO0_2 to value 0"]
impl crate::Resettable for GPO0_GPO0_2_SPEC {
    #[inline(always)]
