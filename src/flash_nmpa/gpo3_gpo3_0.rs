...
pub struct R(crate::R<GPO3_GPO3_0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPO3_GPO3_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPO3_GPO3_0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPO3_GPO3_0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPO3_0` writer"]
pub struct W(crate::W<GPO3_GPO3_0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPO3_GPO3_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPO3_GPO3_0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPO3_GPO3_0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type AUX_BIAS_TRIM_VALID_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, GPO3_GPO3_0_SPEC, bool, O>;
...
pub type AUX_BIAS_ITRIM_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GPO3_GPO3_0_SPEC, u8, u8, 5, O>;
...
pub type AUX_BIAS_VREF1_VCURVE_TRIM_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GPO3_GPO3_0_SPEC, u8, u8, 3, O>;
#[doc = "Field `FIELD` reader - no description available"]
pub type FIELD_R = crate::FieldReader<u8, u8>;
#[doc = "Field `FIELD` writer - no description available"]
pub type FIELD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GPO3_GPO3_0_SPEC, u8, u8, 6, O>;
...
pub type FINAL_TEST_NOT_DONE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GPO3_GPO3_0_SPEC, u8, u8, 4, O>;
impl R {
...
#[doc = "GPO3 register 0 description\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpo3_gpo3_0](index.html) module"]
pub struct GPO3_GPO3_0_SPEC;
impl crate::RegisterSpec for GPO3_GPO3_0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpo3_gpo3_0::R](R) reader structure"]
impl crate::Readable for GPO3_GPO3_0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpo3_gpo3_0::W](W) writer structure"]
impl crate::Writable for GPO3_GPO3_0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets GPO3_0 to value 0"]
impl crate::Resettable for GPO3_GPO3_0_SPEC {
    #[inline(always)]
