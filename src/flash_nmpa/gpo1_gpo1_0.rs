...
pub struct R(crate::R<GPO1_GPO1_0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPO1_GPO1_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPO1_GPO1_0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPO1_GPO1_0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPO1_0` writer"]
pub struct W(crate::W<GPO1_GPO1_0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPO1_GPO1_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPO1_GPO1_0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPO1_GPO1_0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type FINAL_TEST_NOT_DONE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GPO1_GPO1_0_SPEC, u8, u8, 4, O>;
...
pub type PARTCONFIG_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GPO1_GPO1_0_SPEC, u8, u8, 7, O>;
...
pub type DEVICE_TYPE_SEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPO1_GPO1_0_SPEC, bool, O>;
...
pub type SRAM_SIZE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GPO1_GPO1_0_SPEC, u8, u8, 4, O>;
...
pub type FIELD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GPO1_GPO1_0_SPEC, u8, u8, 4, O>;
...
#[doc = "GPO1 register 0 description\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpo1_gpo1_0](index.html) module"]
pub struct GPO1_GPO1_0_SPEC;
impl crate::RegisterSpec for GPO1_GPO1_0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpo1_gpo1_0::R](R) reader structure"]
impl crate::Readable for GPO1_GPO1_0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpo1_gpo1_0::W](W) writer structure"]
impl crate::Writable for GPO1_GPO1_0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets GPO1_0 to value 0"]
impl crate::Resettable for GPO1_GPO1_0_SPEC {
    #[inline(always)]
