...
pub struct R(crate::R<PVT_MONITOR_0_PVT_MONITOR_0_DELAYS_MSB_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PVT_MONITOR_0_PVT_MONITOR_0_DELAYS_MSB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PVT_MONITOR_0_PVT_MONITOR_0_DELAYS_MSB_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PVT_MONITOR_0_PVT_MONITOR_0_DELAYS_MSB_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PVT_MONITOR_0_DELAYS_MSB` writer"]
pub struct W(crate::W<PVT_MONITOR_0_PVT_MONITOR_0_DELAYS_MSB_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PVT_MONITOR_0_PVT_MONITOR_0_DELAYS_MSB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PVT_MONITOR_0_PVT_MONITOR_0_DELAYS_MSB_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PVT_MONITOR_0_PVT_MONITOR_0_DELAYS_MSB_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DELAY_3_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PVT_MONITOR_0_PVT_MONITOR_0_DELAYS_MSB_SPEC, u16, u16, 10, O>;
...
#[doc = "no description available\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pvt_monitor_0_pvt_monitor_0_delays_msb](index.html) module"]
pub struct PVT_MONITOR_0_PVT_MONITOR_0_DELAYS_MSB_SPEC;
impl crate::RegisterSpec for PVT_MONITOR_0_PVT_MONITOR_0_DELAYS_MSB_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pvt_monitor_0_pvt_monitor_0_delays_msb::R](R) reader structure"]
impl crate::Readable for PVT_MONITOR_0_PVT_MONITOR_0_DELAYS_MSB_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pvt_monitor_0_pvt_monitor_0_delays_msb::W](W) writer structure"]
impl crate::Writable for PVT_MONITOR_0_PVT_MONITOR_0_DELAYS_MSB_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PVT_MONITOR_0_DELAYS_MSB to value 0"]
impl crate::Resettable for PVT_MONITOR_0_PVT_MONITOR_0_DELAYS_MSB_SPEC {
    #[inline(always)]
