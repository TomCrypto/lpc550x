...
pub struct R(crate::R<DCDC_POWER_PROFILE_LOW_0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DCDC_POWER_PROFILE_LOW_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DCDC_POWER_PROFILE_LOW_0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DCDC_POWER_PROFILE_LOW_0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DCDC_POWER_PROFILE_LOW_0` writer"]
pub struct W(crate::W<DCDC_POWER_PROFILE_LOW_0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DCDC_POWER_PROFILE_LOW_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DCDC_POWER_PROFILE_LOW_0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DCDC_POWER_PROFILE_LOW_0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DCDC_TRIM_VALID_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, DCDC_POWER_PROFILE_LOW_0_SPEC, bool, O>;
...
pub type RC_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DCDC_POWER_PROFILE_LOW_0_SPEC, u8, u8, 6, O>;
...
pub type ICOMP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DCDC_POWER_PROFILE_LOW_0_SPEC, u8, u8, 2, O>;
...
pub type TMOS_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DCDC_POWER_PROFILE_LOW_0_SPEC, u8, u8, 5, O>;
...
pub type VOUT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DCDC_POWER_PROFILE_LOW_0_SPEC, u8, u8, 4, O>;
...
#[doc = "no description available.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dcdc_power_profile_low_0](index.html) module"]
pub struct DCDC_POWER_PROFILE_LOW_0_SPEC;
impl crate::RegisterSpec for DCDC_POWER_PROFILE_LOW_0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dcdc_power_profile_low_0::R](R) reader structure"]
impl crate::Readable for DCDC_POWER_PROFILE_LOW_0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dcdc_power_profile_low_0::W](W) writer structure"]
impl crate::Writable for DCDC_POWER_PROFILE_LOW_0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DCDC_POWER_PROFILE_LOW_0 to value 0"]
impl crate::Resettable for DCDC_POWER_PROFILE_LOW_0_SPEC {
    #[inline(always)]
