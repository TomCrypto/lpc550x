...
pub struct R(crate::R<AUX_BIAS_CURVE_AMBIENT_1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<AUX_BIAS_CURVE_AMBIENT_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<AUX_BIAS_CURVE_AMBIENT_1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<AUX_BIAS_CURVE_AMBIENT_1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `AUX_BIAS_CURVE_AMBIENT_1` writer"]
pub struct W(crate::W<AUX_BIAS_CURVE_AMBIENT_1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<AUX_BIAS_CURVE_AMBIENT_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<AUX_BIAS_CURVE_AMBIENT_1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<AUX_BIAS_CURVE_AMBIENT_1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type VREF1VCURVETRIM_2_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, AUX_BIAS_CURVE_AMBIENT_1_SPEC, u16, u16, 16, O>;
...
#[doc = "Aux Bias Curve Ambient (30degC)\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [aux_bias_curve_ambient_1](index.html) module"]
pub struct AUX_BIAS_CURVE_AMBIENT_1_SPEC;
impl crate::RegisterSpec for AUX_BIAS_CURVE_AMBIENT_1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [aux_bias_curve_ambient_1::R](R) reader structure"]
impl crate::Readable for AUX_BIAS_CURVE_AMBIENT_1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [aux_bias_curve_ambient_1::W](W) writer structure"]
impl crate::Writable for AUX_BIAS_CURVE_AMBIENT_1_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets AUX_BIAS_CURVE_AMBIENT_1 to value 0"]
impl crate::Resettable for AUX_BIAS_CURVE_AMBIENT_1_SPEC {
    #[inline(always)]
