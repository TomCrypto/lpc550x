...
pub struct R(crate::R<GPO2_GPO2_0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPO2_GPO2_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPO2_GPO2_0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPO2_GPO2_0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPO2_0` writer"]
pub struct W(crate::W<GPO2_GPO2_0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPO2_GPO2_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPO2_GPO2_0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPO2_GPO2_0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type USBHS_PHY_TRIM_VALID_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, GPO2_GPO2_0_SPEC, bool, O>;
...
pub type TRIM_USB_REG_ENV_TAIL_ADJ_VD_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GPO2_GPO2_0_SPEC, u8, u8, 2, O>;
...
pub type TRIM_USBPHY_TX_D_CAL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GPO2_GPO2_0_SPEC, u8, u8, 4, O>;
...
pub type TRIM_USBPHY_TX_CAL45DP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GPO2_GPO2_0_SPEC, u8, u8, 5, O>;
...
pub type TRIM_USB2_REFBIAS_VBGADJ_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GPO2_GPO2_0_SPEC, u8, u8, 3, O>;
...
#[doc = "GPO2 register 0 description\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpo2_gpo2_0](index.html) module"]
pub struct GPO2_GPO2_0_SPEC;
impl crate::RegisterSpec for GPO2_GPO2_0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpo2_gpo2_0::R](R) reader structure"]
impl crate::Readable for GPO2_GPO2_0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpo2_gpo2_0::W](W) writer structure"]
impl crate::Writable for GPO2_GPO2_0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets GPO2_0 to value 0"]
impl crate::Resettable for GPO2_GPO2_0_SPEC {
    #[inline(always)]
