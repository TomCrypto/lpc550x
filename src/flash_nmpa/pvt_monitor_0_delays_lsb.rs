...
pub struct R(crate::R<PVT_MONITOR_0_DELAYS_LSB_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PVT_MONITOR_0_DELAYS_LSB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PVT_MONITOR_0_DELAYS_LSB_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PVT_MONITOR_0_DELAYS_LSB_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PVT_MONITOR_0_DELAYS_LSB` writer"]
pub struct W(crate::W<PVT_MONITOR_0_DELAYS_LSB_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PVT_MONITOR_0_DELAYS_LSB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PVT_MONITOR_0_DELAYS_LSB_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PVT_MONITOR_0_DELAYS_LSB_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DELAY_VALID_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PVT_MONITOR_0_DELAYS_LSB_SPEC, bool, O>;
...
pub type DELAY_0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PVT_MONITOR_0_DELAYS_LSB_SPEC, u16, u16, 10, O>;
...
#[doc = "no description available.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pvt_monitor_0_delays_lsb](index.html) module"]
pub struct PVT_MONITOR_0_DELAYS_LSB_SPEC;
impl crate::RegisterSpec for PVT_MONITOR_0_DELAYS_LSB_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pvt_monitor_0_delays_lsb::R](R) reader structure"]
impl crate::Readable for PVT_MONITOR_0_DELAYS_LSB_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pvt_monitor_0_delays_lsb::W](W) writer structure"]
impl crate::Writable for PVT_MONITOR_0_DELAYS_LSB_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PVT_MONITOR_0_DELAYS_LSB to value 0"]
impl crate::Resettable for PVT_MONITOR_0_DELAYS_LSB_SPEC {
    #[inline(always)]
