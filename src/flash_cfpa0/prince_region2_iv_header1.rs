...
pub type TYPE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PRINCE_REGION2_IV_HEADER1_SPEC, u8, u8, 2, O>;
...
pub type INDEX_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PRINCE_REGION2_IV_HEADER1_SPEC, u8, u8, 4, O>;
...
pub type SIZE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PRINCE_REGION2_IV_HEADER1_SPEC, u8, u8, 6, O>;
impl R {
