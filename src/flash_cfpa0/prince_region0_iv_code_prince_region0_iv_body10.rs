...
impl From<crate::R<PRINCE_REGION0_IV_CODE_PRINCE_REGION0_IV_BODY10_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<PRINCE_REGION0_IV_CODE_PRINCE_REGION0_IV_BODY10_SPEC>> for W {
    #[inline(always)]
...
pub type FIELD_W<'a, const O: u8> = crate::FieldWriter<
    'a,
    u32,
    PRINCE_REGION0_IV_CODE_PRINCE_REGION0_IV_BODY10_SPEC,
    u32,
    u32,
    32,
    O,
